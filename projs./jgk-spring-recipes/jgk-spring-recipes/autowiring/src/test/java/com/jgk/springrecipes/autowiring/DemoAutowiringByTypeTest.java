...
@ContextConfiguration({"/com/jgk/springrecipes/autowiring/DemoAutowiringByTypeTest-context.xml"})//({"/applicationContext.xml", "/applicationContext-test.xml"})
public class DemoAutowiringByTypeTest {
