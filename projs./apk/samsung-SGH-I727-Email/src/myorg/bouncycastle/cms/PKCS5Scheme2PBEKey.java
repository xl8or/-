...
public class PKCS5Scheme2PBEKey extends CMSPBEKey {
   ...
   public PKCS5Scheme2PBEKey(char[] var1, AlgorithmParameters var2) throws InvalidAlgorithmParameterException {
      PBEParameterSpec var3 = getParamSpec(var2);
      super(var1, var3);
   }

   public PKCS5Scheme2PBEKey(char[] var1, byte[] var2, int var3) {
      super(var1, var2, var3);
   }

   byte[] getEncoded(String var1) {
      PKCS5S2ParametersGenerator var2 = new PKCS5S2ParametersGenerator();
      byte[] var3 = PBEParametersGenerator.PKCS5PasswordToBytes(this.getPassword());
