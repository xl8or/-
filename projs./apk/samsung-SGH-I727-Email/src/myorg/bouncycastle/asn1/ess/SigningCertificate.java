...
import myorg.bouncycastle.asn1.ess.ESSCertID;
...
public class SigningCertificate extends ASN1Encodable {
   ...
   public SigningCertificate(ASN1Sequence var1) {
   ...
   public static SigningCertificate getInstance(Object var0) {
      SigningCertificate var1;
      if(var0 != null && !(var0 instanceof SigningCertificate)) {
         if(!(var0 instanceof ASN1Sequence)) {
            StringBuilder var3 = (new StringBuilder()).append("unknown object in \'SigningCertificate\' factory : ");
         ...
         var1 = new SigningCertificate(var2);
      } else {
         var1 = (SigningCertificate)var0;
      }
   ...
   public ESSCertID[] getCerts() {
      ...
      while(true) {
         ...
         ESSCertID var4 = ESSCertID.getInstance(this.certs.getObjectAt(var2));
         var1[var2] = var4;
         ++var2;
      }
   }
