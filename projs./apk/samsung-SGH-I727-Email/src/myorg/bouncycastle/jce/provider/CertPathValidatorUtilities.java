...
public class CertPathValidatorUtilities {
   ...
   private static DERObject getObject(String var0, byte[] var1) throws AnnotatedException {
      try {
         byte[] var2 = ((ASN1OctetString)(new ASN1InputStream(var1)).readObject()).getOctets();
         DERObject var3 = (new ASN1InputStream(var2)).readObject();
         return var3;
      } catch (Exception var6) {
         String var5 = "exception processing extension " + var0;
         throw new AnnotatedException(var5, var6);
      }
   }
