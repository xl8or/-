...
public class SevenBroadCastReceiver extends BroadcastReceiver {
   ...
   private void sendBroadcastSevenMessageAdd(Context var1, long var2) {
      String[] var4 = new String[1];
      String var5 = Long.toString(var2);
      var4[0] = var5;
      Intent var6 = new Intent("com.sec.android.socialhub.action.EXTERNAL_DB_UPDATE");
      Intent var7 = var6.putExtra("intentType", 400);
      var6.putExtra("id_array", var4);
      Intent var9 = var6.putExtra("action", 1);
      Intent var10 = var6.putExtra("status", 0);
      var1.sendBroadcast(var6);
      int var11 = Log.d("Email", "+_+_+_+_+_+_+_+_+_+_+_+_+_+_+ sendBroadcastSevenMessageAdd() ");
   }
   ...
   public void onReceive(Context var1, Intent var2) {
      ...
      if(SEVEN_ACTION != null) {
         if(SEVEN_ACTION.equals("com.seven.Z7.EMAIL_RECEIVED")) {
            ...
            this.sendBroadcastSevenMessageAdd(var1, var47);
