...
public class AddTextSelectorAdapter extends IconListAdapter {
   ...
   protected static List<IconListAdapter.IconListItem> getData(Context var0) {
      ...
      String var2 = var0.getString(2131166813);
      addItem(var1, var2, 2130837553, 5);
      String var3 = var0.getString(2131166569);
      addItem(var1, var3, 2130837550, 0);
      String var4 = var0.getString(2131166581);
      addItem(var1, var4, 2130837547, 4);
      String var5 = var0.getString(2131166570);
      addItem(var1, var5, 2130837542, 2);
      String var6 = var0.getString(2131166571);
      addItem(var1, var6, 2130837548, 3);
      return var1;
   }
