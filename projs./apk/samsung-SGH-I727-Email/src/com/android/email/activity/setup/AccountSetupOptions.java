...
public class AccountSetupOptions extends Activity implements OnClickListener {
   ...
   public AccountSetupOptions() {
      ...
      AccountSetupOptions.1 var2 = new AccountSetupOptions.1();
   ...
   private void enableEASCalendarSyncWindowSpinner() {
      this.findViewById(2131361899).setVisibility(0);
      this.mCalendarSyncWindowView.setVisibility(0);
      CharSequence[] var1 = this.getResources().getTextArray(2131296290);
      CharSequence[] var2 = this.getResources().getTextArray(2131296289);
      ...
      while(true) {
         ...
         if(var4 >= var5) {
            ...
            var9.setDropDownViewResource(2130903190);
   ...
   private void enableEASEmailSizeSpinner() {
      this.findViewById(2131361897).setVisibility(0);
      this.mEmailSizeView.setVisibility(0);
      int var1 = -1;
      String var2 = this.getString(2131166667);
   ...
   private void enableEASSyncWindowSpinner() {
      ...
      while(true) {
         ...
         if(var5 >= var6) {
            ...
            var11.setDropDownViewResource(2130903190);
   ...
   private void showErrorDialog(int var1, Object ... var2) {
      ...
      AccountSetupOptions.2 var4 = new AccountSetupOptions.2(var1, var2);
      var3.post(var4);
   }
   ...
   class 1 implements AccountManagerCallback<Bundle> {
      ...
      public void run(AccountManagerFuture<Bundle> var1) {
         try {
            ...
            AccountSetupOptions.1.1 var4 = new AccountSetupOptions.1.1();
            var3.post(var4);
            return;
         ...
         Integer var10 = Integer.valueOf(2131166914);
         var9[0] = var10;
         var8.showErrorDialog(2131166409, var9);
      }
   ...
   class 2 implements Runnable {
      ...
      public void run() {
         ...
         String var3 = AccountSetupOptions.this.getString(2131166401);
         ...
         String var10 = AccountSetupOptions.this.getString(2131166416);
         AccountSetupOptions.2.1 var11 = new AccountSetupOptions.2.1();
