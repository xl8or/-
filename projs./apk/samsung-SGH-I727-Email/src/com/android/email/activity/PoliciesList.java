...
public class PoliciesList extends Activity {
      ...
      if(var1 != null) {
         ...
         while(var1.moveToNext()) {
            ...
            if(var4.equals("AllowCamera")) {
               var4 = this.getResources().getString(2131166824);
            } else if(var4.equals("AllowTextMessaging")) {
               var4 = this.getResources().getString(2131166828);
            } else if(var4.equals("AllowWifi")) {
               var4 = this.getResources().getString(2131166829);
            } else if(var4.equals("AllowBluetoothMode")) {
               var4 = this.getResources().getString(2131166822);
               if("0".equals(var5)) {
                  var5 = this.getString(2131166854);
               } else if("1".equals(var5)) {
                  var5 = this.getString(2131166856);
               } else if("2".equals(var5)) {
                  var5 = this.getString(2131166855);
               }
            } else if(var4.equals("AllowInternetSharing")) {
               var4 = this.getResources().getString(2131166826);
            } else if(var4.equals("AllowPOPIMAPEmail")) {
               var4 = this.getResources().getString(2131166827);
            } else if(var4.equals("AllowBrowser")) {
               var4 = this.getResources().getString(2131166823);
            } else if(var4.equals("AllowHTMLEmail")) {
               var4 = this.getResources().getString(2131166825);
            } else if(var4.equals("AllowStorageCard")) {
               var4 = this.getResources().getString(2131166830);
               ...
               var4 = this.getResources().getString(2131166847);
               ...
               String var12 = this.getString(2131166858);
               var5 = var11.append(var12).toString();
            } else if(var4.equals("DevicePasswordHistory")) {
               var4 = this.getResources().getString(2131166850);
               if("0".equals(var5)) {
                  continue;
               }
               ...
               String var16 = this.getString(2131166857);
               ...
               String var20 = this.getString(2131166857);
               ...
               String var24 = this.getString(2131166857);
               ...
               if("1".equals(var5)) {
                  var5 = this.getResources().getString(2131166859);
               } else if("2".equals(var5)) {
                  var5 = this.getResources().getString(2131166860);
               } else if("3".equals(var5)) {
                  var5 = this.getResources().getString(2131166861);
               }
               ...
               if(var4.equals("AllowDesktopSync")) {
                  var4 = this.getResources().getString(17040091);
               } else {
                  ...
                  if(var4.equals("MaxInactivityTime")) {
                     ...
                     if("0".equals(var5)) {
                        var5 = this.getResources().getString(2131166783);
                     } else if("1".equals(var5)) {
                        var5 = this.getResources().getString(2131166784);
                     }
                  } else if(var4.equals("RequireEncryptionSMIMEAlgorithm")) {
                     var4 = this.getResources().getString(2131166845);
                     if("0".equals(var5)) {
                        var5 = this.getResources().getString(2131166785);
                     } else if("1".equals(var5)) {
                        var5 = this.getResources().getString(2131166786);
                     } else if("2".equals(var5)) {
                        var5 = this.getResources().getString(2131166787);
                     } else if("3".equals(var5)) {
                        var5 = this.getResources().getString(2131166788);
                     } else if("4".equals(var5)) {
                        var5 = this.getResources().getString(2131166789);
                     }
                  } else if(var4.equals("MaxEmailAgeFilter")) {
                     var4 = this.getResources().getString(17040073);
                     if("0".equals(var5)) {
                        var5 = this.getResources().getString(2131166408);
                     } else if("1".equals(var5)) {
                        var5 = this.getResources().getString(2131166403);
                     } else if("2".equals(var5)) {
                        var5 = this.getResources().getString(2131166404);
                     } else if("3".equals(var5)) {
                        var5 = this.getResources().getString(2131166405);
                     } else if("4".equals(var5)) {
                        var5 = this.getResources().getString(2131166406);
                     } else if("5".equals(var5)) {
                        var5 = this.getResources().getString(2131166407);
                     }
                     ...
                     if("0".equals(var5)) {
                        ...
                        var5 = this.getResources().getString(2131166926);
                     } else if("7".equals(var5)) {
                        var5 = this.getResources().getString(2131166927);
                     }

                     var4 = this.getResources().getString(17040071);
                  }
               }
            }
            ...
            if(var3) {
               if(var5.trim().equalsIgnoreCase("true")) {
                  var5 = this.getApplicationContext().getResources().getString(2131166855);
               }

               if(var5.trim().equalsIgnoreCase("false")) {
                  var5 = this.getApplicationContext().getResources().getString(2131166854);
               }
            }
   ...
   protected void onCreate(Bundle var1) {
      ...
      if(var2 != 65535L) {
         ...
         if(account != null) {
            ...
            this.setContentView(2130903177);
            TextView var9 = (TextView)this.findViewById(2131362490);
            this.mAccountText = var9;
            TextView var10 = this.mAccountText;
            String var11 = account.mDisplayName;
            var10.setText(var11);
            ListView var12 = (ListView)this.findViewById(2131362491);
            ...
            PoliciesList.PolicyAdapter var17 = new PoliciesList.PolicyAdapter(var15, 2130903179, var16);
   ...
   private class PolicyAdapter extends ArrayAdapter<PoliciesList.PolicyItem> {
      ...
      public View getView(int var1, View var2, ViewGroup var3) {
         View var4;
         if(var1 == 0) {
            var4 = this.mInflater.inflate(2130903178, var3, (boolean)0);
         } else {
            ...
            TextView var8 = (TextView)var2.findViewById(2131362493);
            var7.text = var8;
            TextView var9 = (TextView)var2.findViewById(2131362494);
            var7.value = var9;
            var2.setTag(var7);
            ArrayList var10 = PoliciesList.this.policyList;
            int var11 = var1 - 1;
            String var12 = ((PoliciesList.PolicyItem)var10.get(var11)).getPolicyValue();
            String var13 = PoliciesList.this.getString(2131166854);
