...
public class MessageComposePreview extends Activity {
   ...
   private void addAttachment(ArrayList<String> var1) {
      if(var1.size() > 0) {
         ...
         while(true) {
            ...
            RelativeLayout var6 = (RelativeLayout)var4.inflate(2130903109, var5, (boolean)0);
            TextView var7 = (TextView)var6.findViewById(2131362114);
            CharSequence var8 = (CharSequence)var1.get(var2);
            var7.setText(var8);
            int var9 = var1.size() - 1;
            if(var2 == var9) {
               ((ImageView)var6.findViewById(2131362111)).setVisibility(8);
            }
   ...
   private void initViews() {
      TextView var1 = (TextView)this.findViewById(2131362118);
      this.mRecipientToText = var1;
      TextView var2 = (TextView)this.findViewById(2131362120);
      this.mRecipientCcText = var2;
      TextView var3 = (TextView)this.findViewById(2131362122);
      this.mRecipientBccText = var3;
      TextView var4 = (TextView)this.findViewById(2131362124);
      this.mSubjectText = var4;
      TextView var5 = (TextView)this.findViewById(2131362125);
      this.mContentText = var5;
      LinearLayout var6 = (LinearLayout)this.findViewById(2131362119);
      this.mRecipientCcLayout = var6;
      LinearLayout var7 = (LinearLayout)this.findViewById(2131362121);
      this.mRecipientBccLayout = var7;
      LinearLayout var8 = (LinearLayout)this.findViewById(2131362126);
