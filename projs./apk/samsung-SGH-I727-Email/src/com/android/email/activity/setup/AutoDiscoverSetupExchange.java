...
public class AutoDiscoverSetupExchange extends Activity {
   ...
   private void enableDisableNextButton() {
      ...
      if(var1 != 0) {
         ...
         Drawable var4 = var2.getDrawable(2130837914);
         var3.setEmailTwSoftkeyItemImage(var4);
      } else {
         EmailTwSoftkeyItem var5 = this.mNextButton;
         Drawable var6 = var2.getDrawable(2130837915);
   ...
   protected void onCreate(Bundle var1) {
      ...
      EditText var5 = (EditText)((EditText)this.findViewById(2131361980));
      this.mEmailText = var5;
      EditText var6 = (EditText)((EditText)this.findViewById(2131361849));
      this.mPasswordText = var6;
      EditText var7 = (EditText)((EditText)this.findViewById(2131361981));
      this.mDomainText = var7;
      EditText var8 = (EditText)((EditText)this.findViewById(2131361982));
      ...
      this.setSmartValues();
      EmailTwSoftkeyItem var10 = (EmailTwSoftkeyItem)this.findViewById(2131361983);
