...
public class AccountSetupBasicExchange extends Activity implements OnClickListener, OnCheckedChangeListener, TextWatcher {
   ...
   private void onExchange(boolean var1) {
      ...
      byte var2 = -1;
      SyncScheduleData var3 = new SyncScheduleData(480, 1020, 62, -1, var2, 0);
   ...
   private void showsCredentialToast() {
      ...
      if(var3) {
         if(this.toastForCredential == null) {
            String var4 = this.getString(2131166993);
   ...
   private boolean validateFields() {
      ...
      Drawable var6 = this.getResources().getDrawable(2130837914);
      Drawable var7 = this.getResources().getDrawable(2130837915);
      if(var4 != 0) {
   ...
   public Dialog onCreateDialog(int var1) {
      ...
      case 2:
         ...
         Builder var16 = var14.setPositiveButton(2131166260, var15);
         AccountSetupBasicExchange.4 var17 = new AccountSetupBasicExchange.4();
         Builder var18 = var16.setNegativeButton(2131166261, var17);
