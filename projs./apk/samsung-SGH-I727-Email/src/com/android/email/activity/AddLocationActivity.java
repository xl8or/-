...
public class AddLocationActivity extends Activity {
   ...
   protected void onActivityResult(int var1, int var2, Intent var3) {
      ...
      if(var1 == 1 && var2 == -1) {
         ...
         if(TextUtils.isEmpty(var5) && TextUtils.isEmpty(var4)) {
            Toast.makeText(this.getBaseContext(), 2131166592, 1).show();
         } else {
   ...
   protected Dialog onCreateDialog(int var1, Bundle var2) {
      ...
      case 1:
         ...
         Builder var5 = var4.setTitle(2131166581);
         String[] var6 = new String[2];
         String var7 = this.getString(2131166582);
         var6[0] = var7;
         String var8 = this.getString(2131166583);
         var6[1] = var8;
      ...
      case 2:
         ...
         Builder var14 = var13.setTitle(2131166584);
         Builder var15 = var13.setMessage(2131166585);
         String var16 = this.getString(2131166586);
         AddLocationActivity.3 var17 = new AddLocationActivity.3();
         var13.setPositiveButton(var16, var17);
         String var19 = this.getString(2131166587);
