...
public class AccountSetupSelectService extends Activity implements OnClickListener {
   ...
   protected void onCreate(Bundle var1) {
      ...
      this.setTitle(var10);
      CheckBox var11 = (CheckBox)this.findViewById(2131361959);
      this.syncContacts = var11;
      LinearLayout var12 = (LinearLayout)this.findViewById(2131361954);
      this.syncContactsLayout = var12;
      LinearLayout var13 = (LinearLayout)this.findViewById(2131361961);
      this.syncCalendarLayout = var13;
      LinearLayout var14 = (LinearLayout)this.findViewById(2131361966);
      ...
      if(this.isAccountForGmail()) {
         this.findViewById(2131361961).setVisibility(8);
         this.findViewById(2131361954).setVisibility(8);
      } else if(this.isAccountForMsn()) {
         this.findViewById(2131361961).setVisibility(8);
      } else {
         CheckBox var17 = (CheckBox)this.findViewById(2131361965);
         this.syncCalendar = var17;
      }

      if(this.isExistIMPackage()) {
         CheckBox var15 = (CheckBox)this.findViewById(2131361970);
         this.signonIM = var15;
         if(AccountSetupBasics.sso_fromIM) {
            this.findViewById(2131361966).setVisibility(8);
         } else {
      ...
      ((EmailTwSoftkeyItem)this.findViewById(2131361877)).setOnClickListener(this);
