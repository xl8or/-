...
class ShareText extends ToolTipItem implements OnClickListener {
   ...
   public void onItemSelected() {
      if(this.mTextSelector == null) {
         ...
         Builder var7 = var6.setTitle(2131167040);
         ShareText.1 var8 = new ShareText.1(var2, var3);
         var6.setItems(2131296312, var8);
         var6.create().show();
      }
   }
      ...
      public void onClick(DialogInterface var1, int var2) {
         ...
         case 1:
            ...
            try {
               ...
               String var8 = this.val$mBrowserActivity.getString(2131167041);
         ...
         case 2:
            ...
            if(var10 == null) {
               ...
               try {
                  ...
                  String var25 = this.val$mBrowserActivity.getString(2131167041);
