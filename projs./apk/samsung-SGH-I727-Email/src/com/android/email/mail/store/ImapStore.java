...
public class ImapStore extends Store {
   ...
   // $FF: synthetic method
   static Transport access$200(ImapStore var0) {
      return var0.mRootTransport;
   }

   // $FF: synthetic method
   static Context access$300(ImapStore var0) {
      return var0.mContext;
   }

   // $FF: synthetic method
   static String access$400(ImapStore var0) {
   ...
   // $FF: synthetic method
   static String access$502(ImapStore var0, String var1) {
      var0.mIdPhrase = var1;
      return var1;
   }
      ...
      public void appendMessages(Message[] var1) throws MessagingException {
         ...
         try {
            ...
            for(int var4 = 0; var4 < var3; ++var4) {
               ...
               var7.flush();
               String var10 = "";
               Flag[] var11 = var5.getFlags();
               if(var11.length > 0) {
                  StringBuilder var12 = new StringBuilder();
                  int var13 = 0;

                  for(int var14 = var11.length; var13 < var14; ++var13) {
                     Flag var15 = var11[var13];
                     Flag var16 = Flag.SEEN;
                     if(var15 == var16) {
                        String var20 = " \\SEEN";
                        var12.append(var20);
                     } else {
                        Flag var22 = Flag.FLAGGED;
                        if(var15 == var22) {
                           String var26 = " \\FLAGGED";
                           var12.append(var26);
                        }
                     }
                  }
                  ...
                  if(var12.length() > 0) {
                     byte var35 = 1;
                     var10 = var12.substring(var35);
                  }
               }

               ImapStore.ImapConnection var36 = this.mConnection;
               Object[] var37 = new Object[3];
               String var38 = ImapStore.encodeFolderName(this.mName);
               var37[0] = var38;
               var37[1] = var10;
               Long var39 = Long.valueOf(var6.getCount());
               var37[2] = var39;
               String var40 = String.format("APPEND \"%s\" (%s) {%d}", var37);
               var36.sendCommand(var40, (boolean)0);

               ImapResponse var42;
               do {
                  var42 = this.mConnection.readResponse();
                  if(var42.isContinuationRequest()) {
                     EOLConvertingOutputStream var43 = new EOLConvertingOutputStream;
                     OutputStream var44 = this.mConnection.mTransport.getOutputStream();
                     var43.<init>(var44);
                     var5.writeTo(var43);
                     byte var48 = 13;
                     var43.write(var48);
                     ...
                     var43.write(var50);
                     var43.flush();
                  } else if(!var42.isTagged()) {
                     this.handleUntaggedResponse(var42);
                  }
               } while(!var42.isTagged());

               byte var52 = 1;
               ImapList var53 = var42.getListOrEmpty(var52);
               int var54 = var53.size();
               byte var55 = 3;
               if(var54 >= var55) {
                  byte var57 = 0;
                  String var58 = "APPENDUID";
                  if(var53.is(var57, var58)) {
                     byte var60 = 2;
                     String var61 = var53.getStringOrEmpty(var60).getString();
                     if(!TextUtils.isEmpty(var61)) {
                        var5.setUid(var61);
                        continue;
                     }
                  }
               ...
               String var66 = var5.getMessageId();
               if(var66 != null && var66.length() != 0) {
                  Object[] var67 = new Object[]{var66};
                  String var68 = String.format("(HEADER MESSAGE-ID %s)", var67);
                  String[] var71 = this.searchForUids(var68);
                  if(var71.length > 0) {
                     String var72 = var71[0];
                     var5.setUid(var72);
                  }
               }
            }
         } catch (IOException var77) {
            ImapStore.ImapConnection var29 = this.mConnection;
            throw this.ioExceptionHandler(var29, var77);
         } finally {
            this.destroyResponses();
         }
