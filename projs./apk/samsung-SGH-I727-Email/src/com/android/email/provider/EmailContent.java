...
public abstract class EmailContent {
   ...
   public static final class Account extends EmailContent implements EmailContent.AccountColumns, Parcelable {
      ...
      public EmailContent.Account restore(Cursor var1) {
         ...
         SyncScheduleData var34 = this.mSyncScheduleData;
         int var35 = var1.getInt(24);
         var34.setOffPeakSchedule(var35);
         SyncScheduleData var36 = this.mSyncScheduleData;
         int var37 = var1.getInt(25);
         var36.setRoamingSchedule(var37);
         int var38 = var1.getInt(26);
         this.mCalendarSyncLookback = var38;
         int var39 = var1.getInt(15);
         this.mSecurityFlags = var39;
         String var40 = var1.getString(16);
         this.mSecuritySyncKey = var40;
         String var41 = var1.getString(17);
         this.mSignature = var41;
         int var42 = var1.getInt(27);
         this.mTypeMsg = var42;
         long var43 = (long)var1.getInt(28);
         this.mSevenAccountKey = var43;
         long var45 = (long)var1.getInt(30);
         this.mTimeLimit = var45;
         long var47 = (long)var1.getInt(29);
         this.mSizeLimit = var47;
         int var49 = var1.getInt(31);
         this.mPeakTime = var49;
         int var50 = var1.getInt(32);
         this.mOffPeakTime = var50;
         String var51 = var1.getString(33);
         this.mDays = var51;
         String var52 = var1.getString(34);
         this.mPeakStartTime = var52;
         String var53 = var1.getString(35);
         this.mPeakEndTime = var53;
         int var54 = var1.getInt(36);
         this.mWhileroaming = var54;
         int var55 = var1.getInt(37);
         this.mAttachmentEnabled = var55;
         String var56 = var1.getString(38);
         this.mSmimeOwnCertificateAlias = var56;
         int var57 = var1.getInt(39);
         this.setSmimeFlags(var57);
         int var58 = var1.getInt(40);
         this.mSmimeSignAlgorithm = var58;
         int var59 = var1.getInt(41);
         this.mSmimeEncryptionAlgorithm = var59;
         int var60 = var1.getInt(44);
         this.mDeviceInfoSent = var60;
         int var61 = var1.getInt(45);
         this.mdeviceBlockedType = var61;
         int var62 = var1.getInt(46);
         this.mConflictFlags = var62;
         return this;
      }
         ...
         if(var2.containsKey("isDefault") && var2.getAsBoolean("isDefault").booleanValue()) {
            ...
            label39: {
               try {
                  ...
                  ;
               } catch (OperationApplicationException var24) {
                  ;
               }
   ...
   public static final class Message extends EmailContent implements EmailContent.SyncColumns, EmailContent.MessageColumns {
      ...
      public static final int CONTENT_MISSING_BODY_COLUMN = 45;
      public static final int CONTENT_MISSING_HTML_BODY_COLUMN = 46;
      ...
      public static final int CONTENT_SEVEN_ACCOUNT_KEY_COLUMN = 48;
      public static final int CONTENT_SEVEN_MESSAGE_KEY_COLUMN = 44;
      ...
      public static final int CONTENT_TYPE_MESSAGE_COLUMN = 43;
      public static final int CONTENT_UM_CALLER_ID = 34;
      public static final int CONTENT_UM_USER_NOTES = 35;
      public static final int CONTENT_UNK_ENCODING_COLUMN = 47;
      public static final Uri CONTENT_URI;
      public static final Uri DELETED_CONTENT_URI;
      ...
      static {
         ...
         String[] var13 = new String[]{"_id", "originalId"};
      ...
      public int addSaveOps(ArrayList<ContentProviderOperation> var1) {
         ...
         if(this.mText != null) {
            String var4 = Snippet.fromPlainText(this.mText);
            this.mSnippet = var4;
         } else if(this.mHtml != null) {
            String var28 = Snippet.fromHtmlText(this.mHtml);
            this.mSnippet = var28;
         }
      ...
      public EmailContent.Message restore(Cursor var1) {
         ...
         this.mSnippet = var49;
         if(var1.getColumnCount() > 43) {
            int var50 = var1.getInt(43);
            this.mTypeMsg = var50;
            long var51 = (long)var1.getInt(44);
            this.mSevenMessageKey = var51;
            int var53 = var1.getInt(45);
            this.mMissingBody = var53;
            int var54 = var1.getInt(46);
            this.mMissingHtmlBody = var54;
            int var55 = var1.getInt(47);
            this.mUnkEncoding = var55;
            long var56 = (long)var1.getInt(48);
