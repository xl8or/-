...
public class TextSelector implements WebTextSelectionListener {
   ...
   private void createToolTip() {
      if(this.mIconPopup == null) {
         ...
         CopyText var4 = new CopyText(this, 2131167036);
         var3.addIcon(2130837909, var4, 0, 2131167036);
         IconPopupMenu var5 = this.mIconPopup;
         SearchText var6 = new SearchText(this, 2131167039);
         var5.addIcon(2130837910, var6, 0, 2131167039);
         IconPopupMenu var7 = this.mIconPopup;
         ShareText var8 = new ShareText(this, 2131167040);
         var7.addIcon(2130837911, var8, 0, 2131167040);
      }
   }
