...
public class HTCYahooImapInfo extends ProviderInfo {

   String mNetworkOperator = "";


   public HTCYahooImapInfo() {
      this.loadSetting();
   }

   public HTCYahooImapInfo(String var1) {
      this.mNetworkOperator = var1;
      this.loadSetting();
   }

   protected void loadSetting() {
      super.loadSetting();
      Object var1 = this.mSetting.put("aclid", "HTC");
      ...
      HashMap var17 = this.mSetting;
      String var18 = this.mNetworkOperator;
      var17.put("mobile-net-operator", var18);
   }
}
