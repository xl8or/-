...
public class VCardParser_V21 extends VParser {
   ...
   static {
      String[] var0 = new String[]{"DOM", "INTL", "POSTAL", "PARCEL", "HOME", "WORK", "PREF", "VOICE", "FAX", "MSG", "CELL", "PAGER", "BBS", "MODEM", "CAR", "ISDN", "VIDEO", "AOL", "APPLELINK", "ATTMAIL", "CIS", "EWORLD", "INTERNET", "IBMMAIL", "MCIMAIL", "POWERSHARE", "PRODIGY", "TLX", "X400", "GIF", "CGM", "WMF", "BMP", "MET", "PMB", "DIB", "PICT", "TIFF", "PDF", "PS", "JPEG", "QTIME", "MPEG", "MPEG2", "AVI", "WAVE", "AIFF", "PCM", "X509", "PGP"};
      List var1 = Arrays.asList(var0);
      mKnownTypeSet = new HashSet(var1);
      String[] var2 = new String[]{"LOGO", "PHOTO", "LABEL", "FN", "TITLE", "SOUND", "VERSION", "TEL", "EMAIL", "TZ", "GEO", "NOTE", "URL", "BDAY", "ROLE", "REV", "UID", "KEY", "MAILER"};
                     ...
                     if(var4 != -1) {
                        ...
                        if(var4 != -1) {
                           ...
                           if(this.mBuilder != null) {
                              ...
                              String var7 = this.mBuffer.substring(var5, var1);
                              var6.propertyParamValue(var7);
                           }
