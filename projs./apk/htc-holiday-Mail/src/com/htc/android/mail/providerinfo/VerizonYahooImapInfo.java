...
public class VerizonYahooImapInfo extends ProviderInfo {

   public VerizonYahooImapInfo() {
      this.loadSetting();
   }
   ...
   protected void loadSetting() {
      ...
      Object var14 = this.mSetting.put("x-android-mobile-net-operator", "verizon");
      HashMap var15 = this.mSetting;
      String var16 = SystemProperties.get("ro.serialno", "HT0123456789");
      var15.put("AGUID", var16);
      Object var18 = this.mSetting.put("ACLID", "Verizon");
   }
}
