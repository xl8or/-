...
public class CalendarSyncEnabler {
   ...
   void showNotification(String var1) {
      ...
      String var5 = this.mContext.getString(2131165453);
      long var6 = System.currentTimeMillis();
      Notification var8 = new Notification(2130837622, var5, var6);
      Context var9 = this.mContext;
      var8.setLatestEventInfo(var9, var5, var1, var4);
      var8.flags = 16;
      ((NotificationManager)this.mContext.getSystemService("notification")).notify(3, var8);
   }
}
