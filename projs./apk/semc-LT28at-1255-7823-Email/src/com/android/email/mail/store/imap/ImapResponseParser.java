...
public class ImapResponseParser {
   ...
   private ImapString parseLiteral() throws IOException, MessagingException {
      ...
      this.expect('\r');
      this.expect('\n');
      PeekableInputStream var3 = this.mIn;
      FixedLengthInputStream var4 = new FixedLengthInputStream(var3, var1);
      int var5 = this.mLiteralKeepInMemoryThreshold;
      Object var6;
      if(var1 > var5) {
         var6 = new ImapTempFileLiteral(var4);
      } else {
         var6 = new ImapMemoryLiteral(var4);
      }

      return (ImapString)var6;
   }
