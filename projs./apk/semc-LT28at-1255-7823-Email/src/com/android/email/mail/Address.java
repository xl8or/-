...
public class Address {
   ...
   public static String decodePersonal(String var0) {
      if(var0 != null) {
         String var1 = REMOVE_OPTIONAL_DQUOTE.matcher(var0).replaceAll("$1");
         var0 = DecoderUtil.decodeEncodedWords(UNQUOTE.matcher(var1).replaceAll("$1"));
         if(var0.length() == 0) {
            var0 = null;
         }
      }
   ...
   public static boolean isAllValid(String var0) {
      ...
      if(var0 != null && var0.length() > 0) {
         Rfc822Token[] var1 = Rfc822Tokenizer.tokenize(var0.replaceAll("\\\\", "\\\\\\\\"));
         int var2 = 0;
   ...
   public static Address[] parse(String var0, boolean ... var1) {
      Address[] var2;
      if(var0 != null && var0.length() != 0) {
         Rfc822Token[] var3 = Rfc822Tokenizer.tokenize(var0.replaceAll("\\\\", "\\\\\\\\"));
         ArrayList var4 = new ArrayList();
         int var5 = 0;

         for(int var6 = var3.length; var5 < var6; ++var5) {
            Rfc822Token var7 = var3[var5];
            String var8 = var7.getAddress();
            if(!TextUtils.isEmpty(var8) && isValidAddress(var8)) {
               ...
               String var10 = Locale.getDefault().getLanguage();
               boolean var11 = "ko".equals(var10);
               if(var1.length == 0 || var1.length == 1 && !var1[0] || !var11) {
                  var9 = decodePersonal(var9);
               }

               Address var12 = new Address(var8, var9);
               var4.add(var12);
            }
         }

         Address[] var14 = new Address[0];
         var2 = (Address[])var4.toArray(var14);
      } else {
         var2 = EMPTY_ADDRESS_ARRAY;
      }
   ...
   public static String parseAndPack(String var0) {
      boolean[] var1 = new boolean[0];
      return pack(parse(var0, var1));
   }
