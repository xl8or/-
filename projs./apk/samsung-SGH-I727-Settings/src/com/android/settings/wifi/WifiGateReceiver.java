...
public class WifiGateReceiver extends BroadcastReceiver {

   public WifiGateReceiver() {}

   public void onReceive(Context var1, Intent var2) {
      StringBuilder var3 = (new StringBuilder()).append("WiFiGateReceiver. received GATE intent. action = ");
      ...
      if(var2.getAction().equals("com.sec.android.gate.GATE")) {
         ...
         StringBuilder var7 = (new StringBuilder()).append("WiFiGateReceiver. received GATE intent. enabled = ");
         ...
         StringBuilder var11 = (new StringBuilder()).append("WiFiGateReceiver. received LCDTEXT intent. enabled = ");
