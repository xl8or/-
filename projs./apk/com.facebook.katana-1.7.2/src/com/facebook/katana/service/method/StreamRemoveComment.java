...
public class StreamRemoveComment extends ApiMethod {
   ...
   public StreamRemoveComment(Context var1, Intent var2, String var3, String var4, ApiMethodListener var5) {
      String var6 = Constants.URL.getApiUrl(var1);
      super(var1, var2, "GET", "stream.removeComment", var6, var5);
      ...
      this.mParams.put("comment_id", var4);
   }
