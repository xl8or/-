...
// Source File Name:   StreamRemove.java
...
public class StreamRemove extends ApiMethod
{
    ...
    public StreamRemove(Context context, Intent intent, String s, String s1, ApiMethodListener apimethodlistener)
    {
        super(context, intent, "GET", "stream.remove", com.facebook.katana.Constants.URL.getApiUrl(context), apimethodlistener);
