...
public class HttpQueryParams extends QueryParams {
   ...
   public String generateQueryUrl(String var1) {
      ...
      while(true) {
         ...
         String var9 = this.getParamValue(var8);
         if(var9 != null) {
            String var10 = this.client.encodeUri(var8);
            StringBuffer var11 = var3.append(var10).append('=');
            String var12 = this.client.encodeUri(var9);
            var3.append(var12);
         }
