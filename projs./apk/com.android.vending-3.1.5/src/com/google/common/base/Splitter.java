...
public final class Splitter {
   ...
   static class 6 {
      ...
      // $FF: synthetic field
      static final int[] $SwitchMap$com$google$common$base$Splitter$AbstractIterator$State = new int[Splitter.AbstractIterator.State.values().length];


      static {
         try {
            int[] var0 = $SwitchMap$com$google$common$base$Splitter$AbstractIterator$State;
         ...
         try {
            int[] var2 = $SwitchMap$com$google$common$base$Splitter$AbstractIterator$State;
   ...
   private abstract static class AbstractIterator<T extends Object> implements Iterator<T> {
      ...
      public final boolean hasNext() {
         ...
         int[] var5 = Splitter.6.$SwitchMap$com$google$common$base$Splitter$AbstractIterator$State;
