...
public class ReSync {
   ...
   private class ResyncTask extends AsyncTask<Void, Integer, Integer> {
      ...
      protected void onPostExecute(Integer var1) {
         ...
         Toast.makeText(ReSync.this.mContext, 2131167198, 0).show();
      }

      protected void onPreExecute() {
         super.onPreExecute();
         Context var1 = ReSync.this.mContext;
         String var2 = ReSync.this.mContext.getResources().getString(2131167193);
         String var3 = ReSync.this.mContext.getResources().getString(2131167196);
