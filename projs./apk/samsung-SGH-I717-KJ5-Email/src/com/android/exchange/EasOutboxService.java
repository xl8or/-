...
public class EasOutboxService extends EasSyncService {
   ...
   private void notifyOutOfMemoryErrorWhileSending(long var1, String var3) {
      ...
      String var10 = this.mContext.getString(2131167216);
      ...
      String var15 = this.mContext.getString(2131166817);
      long var16 = System.currentTimeMillis();
      Notification var18 = new Notification(2130838120, var15, var16);
      Context var19 = this.mContext;
      String var20 = this.mContext.getString(2131166817);
