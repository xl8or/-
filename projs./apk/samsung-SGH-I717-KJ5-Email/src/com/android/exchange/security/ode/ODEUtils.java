...
public class ODEUtils {
   ...
   public static boolean pendingExternalEncryption(Context var0, ComponentName var1) {
      boolean var2;
      if(getDPM(var0).getRequireStorageCardEncryption(var1) && (!DeviceEncryptionManager.getExternalStorageStatus() || !DeviceEncryptionManager.getAppliedStatusForExternal())) {
         var2 = true;
      } else {
         var2 = false;
      }
   ...
   public static boolean pendingInternalEncryption(Context var0, ComponentName var1) {
      boolean var2;
      if(getDPM(var0).getRequireDeviceEncryption(var1) && (!DeviceEncryptionManager.getInternalStorageStatus() || !DeviceEncryptionManager.getAppliedStatusForInternal())) {
         var2 = true;
      } else {
         var2 = false;
      }
