...
public class CalendarSyncAdapterService extends Service {
   ...
   private static final String DIRTY_IN_ACCOUNT = "_sync_dirty=1 AND _sync_account=?";
   ...
   static {
      String[] var0 = new String[]{"_id", "syncKey", "syncInterval"};
      ID_SYNC_KEY_PROJECTION = var0;
   }
