...
public class EasLoadMoreSvc extends EasSyncService {
   ...
   private void prepareCommand(Serializer var1, String var2, String var3) throws IOException {
      if(this.mProtocolVersionDouble.doubleValue() < 12.0D) {
         Serializer var17 = var1.start(5).start(28).start(15).data(16, "Email");
         String var18 = this.mMailbox.mSyncKey;
         Serializer var19 = var17.data(11, var18);
         String var20 = this.mMailbox.mServerId;
         Serializer var21 = var19.data(18, var20).start(23).data(35, "8").data(34, "2").end().start(22).start(10);
         String var22 = this.mMsg.mServerId;
         var21.data(13, var22).end().end().end().end().end().done();
      } else {
         ...
         if(this.mMailbox.mServerId != null && this.mMsg.mServerId != null) {
            ...
            String var15 = this.mMsg.mServerId;
            var1.data(984, var15);
         }
         ...
         if(this.mProtocolVersionDouble.doubleValue() >= 14.1D) {
            Serializer var12 = var1.data(1541, "1");
         }

         Serializer var13 = var1.end();
         if(this.mProtocolVersionDouble.doubleValue() >= 14.1D && MessageList.sRemoveIrmProtectionFlag) {
            Serializer var14 = var1.start(1560).end();
         }
