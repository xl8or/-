...
public class Serializer {
   ...
   public Serializer dataOpaque(int var1, byte[] var2) throws IOException {
      if(var2 == null) {
         String var3 = "Writing null data for tag: " + var1;
         int var4 = Log.e("Serializer", var3);
      }
   ...
   public Serializer textOpaque(byte[] var1) throws IOException {
      if(var1 == null) {
         StringBuilder var2 = (new StringBuilder()).append("Writing null text for pending tag: ");
         int var3 = this.pendingTag;
         String var4 = var2.append(var3).toString();
         ...
         this.buf.write(195);
         ByteArrayOutputStream var6 = this.buf;
         this.writeLiteralOpaque(var6, var1);
         if(this.logging) {
   ...
   void writeLiteralOpaque(OutputStream var1, byte[] var2) throws IOException {
