...
public class ComposeMailAdapter extends AbstractCommandAdapter {
   ...
   private String mIRMTemplateId = null;
   ...
   public ComposeMailAdapter(EmailContent.Mailbox var1, EasSyncService var2, String var3, String var4, String var5, boolean var6, boolean var7, boolean var8) {
      ...
      this.isReply = var8;
      if(var2.mProtocolVersionDouble.doubleValue() >= 14.1D) {
         ContentResolver var9 = var2.mContext.getContentResolver();
         Uri var10 = EmailContent.Message.CONTENT_URI;
         String[] var11 = new String[]{"IRMTemplateId"};
         StringBuilder var12 = (new StringBuilder()).append("_id=");
         String var13 = this.msgId;
         String var14 = var12.append(var13).toString();
         Cursor var15 = var9.query(var10, var11, var14, (String[])null, (String)null);
         if(var15.getCount() > 0) {
            boolean var16 = var15.moveToFirst();
            String var17 = var15.getString(0);
            this.mIRMTemplateId = var17;
            if(Eas.USER_LOG) {
               StringBuilder var18 = (new StringBuilder()).append("composemailadapter:mIRMTemplateId: ");
               String var19 = this.mIRMTemplateId;
               String var20 = var18.append(var19).toString();
               int var21 = Log.i("IRM", var20);
            }
         }
   ...
   public boolean sendLocalChanges(Serializer var1) throws IOException {
      ...
      if(this.msgId != null) {
         ...
         if(this.mIRMTemplateId != null && !this.mIRMTemplateId.equals("")) {
            String var20 = this.mIRMTemplateId;
            var1.data(1556, var20);
         }
         ...
         if(this.nextTag(0) != var1) {
            ...
            while(this.nextTag(0) != 3) {
               if(this.tag == 1362) {
                  ...
                  case 171:
                  case 172:
                     ComposeMailAdapter.this.httpCode = var2;
                     break;
                  default:
            ...
            StringBuilder var10 = (new StringBuilder()).append("httpCode mapped for 14.0: ");
            int var11 = ComposeMailAdapter.this.httpCode;
