...
public class FolderSyncParser extends AbstractSyncParser {
   ...
   public void addParser(ArrayList<ContentProviderOperation> var1) throws IOException {
      ...
      case 7:
         var6.mType = 67;
         int var23 = this.mAccount.mSyncInterval;
         var6.mSyncInterval = var23;
         break;
      case 8:
         var6.mType = 65;
      ...
      case 10:
         ...
         EmailContent.Account var22 = EmailContent.Account.restoreAccountWithId(var19, var20);
         if(var22 == null) {
            return;
         }

         if(Double.parseDouble(var22.mProtocolVersion) < 14.0D) {
            return;
         }
      ...
      if(var6.mType == 96) {
         ...
         var6.mFlagVisible = (boolean)var24;
      }
