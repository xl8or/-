...
public class Tags {
   ...
   public static final int CALENDAR_DISALLOW_NEWTIME_PROPOSAL = 307;
   ...
   public static final int COMPOSE_MAIL = 21;
   public static final int COMPOSE_MAIL_CLIENT_ID = 1361;
   public static final int COMPOSE_MAIL_FOLDER_ID = 1356;
   public static final int COMPOSE_MAIL_INSTANCE_ID = 1359;
   public static final int COMPOSE_MAIL_ITEM_ID = 1357;
   public static final int COMPOSE_MAIL_LONG_ID = 1358;
   public static final int COMPOSE_MAIL_MIME = 1360;
   public static final int COMPOSE_MAIL_PAGE = 1344;
   public static final int COMPOSE_MAIL_REPLACE_MIME = 1353;
   public static final int COMPOSE_MAIL_SAVE_IN_SENT_ITEMS = 1352;
   public static final int COMPOSE_MAIL_SEND_MAIL = 1349;
   public static final int COMPOSE_MAIL_SMART_FORWARD = 1350;
   public static final int COMPOSE_MAIL_SMART_REPLY = 1351;
   public static final int COMPOSE_MAIL_SOURCE = 1355;
   public static final int COMPOSE_MAIL_STATUS = 1362;
   public static final int COMPOSE_MAIL_TYPE = 1354;
   ...
   public static final int CONTACTS_WEIGHTEDRANK = 126;
   ...
   public static final int GAL_PICTURE_DATA = 1042;
   ...
   public static final int IRM = 24;
   public static final int IRM_CONTENT_EXPIRY_DATE = 1555;
   public static final int IRM_CONTENT_OWNER = 1559;
   public static final int IRM_EDIT_ALLOWED = 1545;
   public static final int IRM_EXPORT_ALLOWED = 1552;
   public static final int IRM_EXTRACT_ALLOWED = 1550;
   public static final int IRM_FORWARD_ALLOWED = 1548;
   public static final int IRM_MODIFY_RECIPIENTS_ALLOWED = 1549;
   public static final int IRM_OWNER = 1554;
   public static final int IRM_PAGE = 1536;
   public static final int IRM_PRINT_ALLOWED = 1551;
   public static final int IRM_PROGRAMMATIC_ACCESS_ALLOWED = 1553;
   public static final int IRM_REMOVE_RIGHTS_MANAGEMENT_DISTRIBUTION = 1560;
   public static final int IRM_REPLY_ALLOWED = 1546;
   public static final int IRM_REPLY_ALL_ALLOWED = 1547;
   public static final int IRM_TEMPLATE_DESCRIPTION = 1558;
   public static final int IRM_TEMPLATE_ID = 1556;
   public static final int IRM_TEMPLATE_NAME = 1557;
   public static final int ITEMOPERATIONS = 20;
   public static final int ITEMOPERATIONS_CONVERSATIONID = 1304;
   public static final int ITEMOPERATIONS_DATA = 1292;
   public static final int ITEMOPERATIONS_DELETESUBFOLDERS = 1299;
   public static final int ITEMOPERATIONS_DSTFLDID = 1303;
   public static final int ITEMOPERATIONS_EMPTYFOLDERCONTENTS = 1298;
   public static final int ITEMOPERATIONS_FETCH = 1286;
   public static final int ITEMOPERATIONS_ITEMOPERATIONS = 1285;
   public static final int ITEMOPERATIONS_MOVE = 1302;
   public static final int ITEMOPERATIONS_MOVEALWAYS = 1305;
   public static final int ITEMOPERATIONS_OPTIONS = 1288;
   public static final int ITEMOPERATIONS_PAGE = 1280;
   public static final int ITEMOPERATIONS_PART = 1297;
   public static final int ITEMOPERATIONS_PASSWORD = 1301;
   public static final int ITEMOPERATIONS_PROPERTIES = 1291;
   public static final int ITEMOPERATIONS_RANGE = 1289;
   public static final int ITEMOPERATIONS_RESPONSE = 1294;
   public static final int ITEMOPERATIONS_SCHEMA = 1296;
   public static final int ITEMOPERATIONS_STATUS = 1293;
   public static final int ITEMOPERATIONS_STORE = 1287;
   public static final int ITEMOPERATIONS_TOTAL = 1290;
   public static final int ITEMOPERATIONS_USERNAME = 1300;
   public static final int ITEMOPERATIONS_VERSION = 1295;
   ...
   public static final int RESOLVERECIPIENTS = 10;
   public static final int RESOLVERECIPIENTS_AVAILABILITY = 662;
   public static final int RESOLVERECIPIENTS_CERTIFICATE = 653;
   public static final int RESOLVERECIPIENTS_CERTIFICATES = 652;
   public static final int RESOLVERECIPIENTS_CERTIFICATE_COUNT = 661;
   public static final int RESOLVERECIPIENTS_CERTIFICATE_RETRIEVAL = 657;
   public static final int RESOLVERECIPIENTS_DISPLAY_NAME = 650;
   public static final int RESOLVERECIPIENTS_EMAIL_ADDRESS = 651;
   public static final int RESOLVERECIPIENTS_END_TIME = 664;
   public static final int RESOLVERECIPIENTS_MAX_AMBIGOUS_RECIPIENTS = 660;
   public static final int RESOLVERECIPIENTS_MAX_CERTIFICATES = 659;
   public static final int RESOLVERECIPIENTS_MERGED_FREE_BUSY = 665;
   public static final int RESOLVERECIPIENTS_MINI_CERTIFICATE = 654;
   public static final int RESOLVERECIPIENTS_OPTIONS = 655;
   public static final int RESOLVERECIPIENTS_PAGE = 640;
   public static final int RESOLVERECIPIENTS_RECIPIENT = 649;
   public static final int RESOLVERECIPIENTS_RECIPIENT_COUNT = 658;
   public static final int RESOLVERECIPIENTS_RESOLVERECIPIENTS = 645;
   public static final int RESOLVERECIPIENTS_RESPONSE = 646;
   public static final int RESOLVERECIPIENTS_START_TIME = 663;
   public static final int RESOLVERECIPIENTS_STATUS = 647;
   public static final int RESOLVERECIPIENTS_TO = 656;
   public static final int RESOLVERECIPIENTS_TYPE = 648;
   public static final int RIGHTS_MANAGEMENT_LICENSE = 1544;
   public static final int RIGHTS_MANAGEMENT_SUPPORT = 1541;
   public static final int RIGHTS_MANAGEMENT_TEMPLATE = 1543;
   public static final int RIGHTS_MANAGEMENT_TEMPLATES = 1542;
   public static final int SEARCH = 15;
   public static final int SEARCH_AND = 979;
   public static final int SEARCH_CONVERSATIONID = 992;
   ...
   public static final int SEARCH_MAXPICTURES = 995;
   public static final int SEARCH_MAXSIZE = 994;
   ...
   public static final int SEARCH_USERNAME = 990;
   public static final int SEARCH_VALUE = 978;
   public static final int SETTINGS = 18;
   public static final int SETTINGS_APPLIES_TO_EXT_KNOWN = 1167;
   public static final int SETTINGS_APPLIES_TO_EXT_UNKNOWN = 1168;
   ...
   public static final int SETTINGS_ENABLE_OUTBOUND_SMS = 1185;
   ...
   public static final int SETTINGS_IRM_RIGHT_MANAGEMENT_INFORMATION = 1195;
   public static final int SETTINGS_MOBILE_OPERATOR = 1186;
   public static final int SETTINGS_MODEL = 1175;
   public static final int SETTINGS_OOO = 1161;
   public static final int SETTINGS_OOO_MESSAGE = 1165;
   public static final int SETTINGS_OOO_STATE = 1162;
   ...
   public static final int VALIDATE_CERT = 11;
   public static final int VALIDATE_CERT_CERTIFICATE = 711;
   public static final int VALIDATE_CERT_CERTIFICATES = 710;
   public static final int VALIDATE_CERT_CERTIFICATE_CHAIN = 712;
   public static final int VALIDATE_CERT_CHECKCRL = 713;
   public static final int VALIDATE_CERT_PAGE = 704;
   public static final int VALIDATE_CERT_STATUS = 714;
   public static final int VALIDATE_CERT_VALIDATE_CERT = 709;
   ...
   static {
      ...
      var0[8] = var9;
      String[] var10 = new String[]{"Body", "BodySize", "BodyTruncated", "Categories", "Category", "Complete", "DateCompleted", "DueDate", "UTCDueDate", "Importance", "Recurrence", "RecurrenceType", "RecurrenceStart", "RecurrenceUntil", "RecurrenceOccurrences", "RecurrenceInterval", "RecurrenceDOM", "RecurrenceDOW", "RecurrenceWOM", "RecurrenceMOY", "RecurrenceRegenerate", "RecurrenceDeadOccur", "ReminderSet", "ReminderTime", "Sensitivity", "StartDate", "UTCStartDate", "Subject", "CompressedRTF", "OrdinalDate", "SubordinalDate", "CalendarType", "IsLeapMonth", "FirstDayOfWeek"};
      var0[9] = var10;
      String[] var11 = new String[]{"resolveRecipients", "response", "status", "type", "recipient", "displayName", "emailAddress", "certificates", "certificate", "miniCertificate", "options", "to", "certificateRetrieval", "recipientCount", "maxCertificates", "maxAmbigiousRecipients", "certificateCount", "Availability", "StartTime", "EndTime", "MergedFreeBusy", "Picture", "MaxSize", "Data", "MaxPictures"};
      var0[10] = var11;
      String[] var12 = new String[]{"validateCert", "certificates", "certificate", "certificateChain", "checkCRL", "status"};
      var0[11] = var12;
      ...
      var0[13] = var14;
      String[] var15 = new String[]{"Provision", "Policies", "Policy", "PolicyType", "PolicyKey", "Data", "Status", "RemoteWipe", "EASProvidionDoc", "DevicePasswordEnabled", "AlphanumericDevicePasswordRequired", "DeviceEncryptionEnabled", "PasswordRecoveryEnabled", "-unused-", "AttachmentsEnabled", "MinDevicePasswordLength", "MaxInactivityTimeDeviceLock", "MaxDevicePasswordFailedAttempts", "MaxAttachmentSize", "AllowSimpleDevicePassword", "DevicePasswordExpiration", "DevicePasswordHistory", "AllowStorageCard", "AllowCamera", "RequireDeviceEncryption", "AllowUnsignedApplications", "AllowUnsignedInstallationPackages", "MinDevicePasswordComplexCharacters", "AllowWiFi", "AllowTextMessaging", "AllowPOPIMAPEmail", "AllowBluetooth", "AllowIrDA", "RequireManualSyncWhenRoaming", "AllowDesktopSync", "MaxCalendarAgeFilder", "AllowHTMLEmail", "MaxEmailAgeFilter", "MaxEmailBodyTruncationSize", "MaxEmailHTMLBodyTruncationSize", "RequireSignedSMIMEMessages", "RequireEncryptedSMIMEMessages", "RequireSignedSMIMEAlgorithm", "RequireEncryptionSMIMEAlgorithm", "AllowSMIMEEncryptionAlgorithmNegotiation", "AllowSMIMESoftCerts", "AllowBrowser", "AllowConsumerEmail", "AllowRemoteDesktop", "AllowInternetSharing", "UnapprovedInROMApplicationList", "ApplicationName", "ApprovedApplicationList", "Hash"};
      var0[14] = var15;
      String[] var16 = new String[]{"Search", "Stores", "Store", "Name", "Query", "Options", "Range", "Status", "Response", "Result", "Properties", "Total", "EqualTo", "Value", "And", "Or", "FreeText", "SubstringOp", "DeepTraversal", "LongId", "RebuildResults", "LessThan", "GreateerThan", "Schema", "Supported", "UserName", "Password", "ConversationId", "Picture", "MaxSize", "MAxPictures"};
      var0[15] = var16;
      String[] var17 = new String[]{"GalDisplayName", "GalPhone", "GalOffice", "GalTitle", "GalCompany", "GalAlias", "GalFirstName", "GalLastName", "GalHomePhone", "GalMobilePhone", "GalEmailAddress", "Picture", "Status", "Data"};
      var0[16] = var17;
      String[] var18 = new String[]{"BodyPreference", "BodyPreferenceType", "BodyPreferenceTruncationSize", "AllOrNone", "--unused--", "BaseBody", "BaseData", "BaseEstimatedDataSize", "BaseTruncated", "BaseAttachments", "BaseAttachment", "BaseDisplayName", "FileReference", "BaseMethod", "BaseContentId", "BaseContentLocation", "BaseIsInline", "BaseNativeBodyType", "BaseContentType", "BasePreview", "BodyPartPreference", "BodyPart", "Status"};
      var0[17] = var18;
      String[] var19 = new String[]{"Settings", "Status", "Get", "Set", "oof", "oofState", "startTime", "endTime", "oofMessage", "appliedToInternal", "appliesToExtKnown", "appliesToExtUnknown", "enabled", "replyMessage", "bodyType", "devicePassword", "password", "deviceInformation", "model", "IMEI", "friendlyName", "OS", "OSLanguage", "phoneNumber", "userInformation", "emailAddress", "SMTPAddress", "UserAgent", "outBoundSms", "networkOperator", "PrimarySmtpAddress", "Accounts", "Account", "AccountId", "AccountName", "UserDisplayName", "SendDisabled", "ihsManagementInformation"};
      var0[18] = var19;
      String[] var20 = new String[]{"linkId", "displayName", "isFolder", "creationDate", "lastModifiedDate", "ishidden", "contentLength", "contentType"};
      var0[19] = var20;
      String[] var21 = new String[]{"ItemOperations", "Fetch", "Store", "Options", "Range", "Total", "Properties", "Data", "Status", "Response", "Version", "Schema", "Part", "EmptyFolderContents", "DeleteSubFolders", "UserName", "Password", "Move", "DstFldId", "ConversationId", "MoveAlways"};
      var0[20] = var21;
      String[] var22 = new String[]{"SendMail", "SmartForward", "SmartReply", "SaveInSentItems", "ReplaceMime", "Type", "Source", "FolderId", "ItemId", "LongId", "InstanceId", "MIME", "ClientId", "Status", "AccountId"};
      var0[21] = var22;
      String[] var23 = new String[]{"UmCallerID", "UmUserNotes", "UmAttDuration", "UmAttOrder", "ConversationId", "ConversationIndex", "LastVerbExecuted", "LastVerbExecutionTime", "ReveivedAsBcc", "Sender", "CalendarType", "IsLeapMonth", "AccountId", "FirstDayOfWeek", "MeetingMessageType"};
      var0[22] = var23;
      String[] var24 = new String[]{"Subject", "MessageClass", "LastModifiedDate", "Categories", "Category"};
      var0[23] = var24;
      String[] var25 = new String[]{"RightsManagementSupport", "RightsManagementTemplates", "RightsManagementTemplate", "RightsManagementLicense", "EditAllowed", "ReplyAllowed", "ReplyAllAllowed", "ForwardAllowed", "ModifyRecipientsAllowed", "ExtractAllowed", "PrintAllowed", "ExportAllowed", "ProgrammaticAccessAllowed", "RMOwner", "ContentExpiryDate", "TemplateID", "TemplateName", "TemplateDescription", "ContentOwner", "RemoveRightsManagementDistribution"};
      var0[24] = var25;
      pages = var0;
   }
