      ...
      if(this.mTextSelector != null) {
         ...
         if(var1 != null) {
            if(var1.getWebTextSelectionControls() != null) {
               ...
               RestrictionPolicy var3 = null;
               EnterpriseDeviceManager var4 = (EnterpriseDeviceManager)var1.getContext().getSystemService("enterprise_policy");
               if(var4 != null) {
                  var3 = var4.getRestrictionPolicy();
               }

               if(var3 == null || var3.isClipboardAllowed((boolean)0)) {
                  Toast.makeText(var1.getContext(), 17040279, 0).show();
               }
            }
         }
      }
