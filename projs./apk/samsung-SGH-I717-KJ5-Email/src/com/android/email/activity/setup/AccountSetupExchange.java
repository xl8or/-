...
import com.android.email.certificateManager.InstalledCertificatesList;
...
public class AccountSetupExchange extends Activity implements OnClickListener, OnCheckedChangeListener, OnTouchListener {
   ...
   private EmailTwSoftkeyItem mCBAButton;
   ...
   private LinearLayout mUseClientCertificateViewLayout;
   ...
   private void onNext() {
      try {
         ...
         if(this.mAccount.mCbaCertificateAlias == null) {
            StringBuilder var6 = (new StringBuilder()).append("Had to set CBACert in onNext = ");
            String var7 = this.mAccount.mCbaCertificateAlias;
            String var8 = var6.append(var7).toString();
            int var9 = Log.v("AccountSetupExchange", var8);
         }

         long var10 = this.mAccount.mId;
         String var12 = var1.getHost();
   ...
   private void onOwnCertificate() {
      Intent var1 = new Intent(this, InstalledCertificatesList.class);

      String var2;
      try {
         var2 = SyncManager.getDeviceId(this);
         String var3 = "Device id: " + var2;
         int var4 = Log.d("AccountSettings", var3);
      } catch (Exception var16) {
         StringBuilder var12 = (new StringBuilder()).append("Error while getting device id ");
         String var13 = var16.toString();
         String var14 = var12.append(var13).toString();
         int var15 = Log.e("AccountSettings", var14);
         var16.printStackTrace();
         return;
      }

      var1.putExtra("KEYSTORE_PASSWORD", var2);
      String var6 = this.mCbaCertificateAlias;
      var1.putExtra("CERTIFICATE_ALIAS", var6);
      String var8 = this.mAccount.mEmailAddress;
      var1.putExtra("EMAIL_ADDRESS", var8);
      int var10 = this.RETURN_FROM_CERTIFICATE_LIST;
      this.startActivityForResult(var1, var10);
   }
   ...
   public void onActivityResult(int var1, int var2, Intent var3) {
      if(var1 == 1) {
         ...
         int var5 = this.RETURN_FROM_CERTIFICATE_LIST;
         if(var1 == var5) {
            if(var2 == -1) {
               Bundle var6 = var3.getExtras();
               if(var6 != null) {
                  String var7 = var6.getString("CERTIFICATE_ALIAS");
                  String var8 = "CertificateManager returns alias = " + var7;
                  int var9 = Log.v("AccountSetupExchange", var8);
                  if(var7 != null) {
                     if(!var7.equals("None")) {
                        this.mCbaCertificateAlias = var7;
                     } else {
                        this.mCbaCertificateAlias = null;
                     }
                  }
               }
            }

            StringBuilder var10 = (new StringBuilder()).append("After Activity returns result, alias = ");
            String var11 = this.mCbaCertificateAlias;
            String var12 = var10.append(var11).toString();
            int var13 = Log.v("AccountSetupExchange", var12);
            EmailContent.Account var14 = this.mAccount;
            String var15 = this.mCbaCertificateAlias;
            var14.setCbaCertificate(var15);
         }
      }
   }
   ...
   public void onCheckedChanged(CompoundButton var1, boolean var2) {
      if(var1.getId() == 2131361873) {
         LinearLayout var3 = this.mUseClientCertificateViewLayout;
         byte var4;
         if(var2) {
            var4 = 0;
         } else {
         ...
         LinearLayout var5 = this.mTrustCertificatesViewLayout;
         byte var6;
         if(var2) {
            var6 = 0;
         } else {
         ...
         if(!var2) {
            EmailTwSoftkeyItem var7 = this.mCBAButton;
            byte var8;
            if(var2) {
               var8 = 1;
            } else {
            ...
            var7.setEnabled((boolean)var8);
            CheckBox var11 = this.mUseClientCertificateView;
            if(var2) {
               var6 = 1;
            } else {
               var6 = 0;
            ...
            var11.setChecked((boolean)var6);
         }
      }

      if(var1.getId() == 2131361877) {
         EmailTwSoftkeyItem var9 = this.mCBAButton;
         byte var10;
         if(var2) {
            var10 = 1;
         } else {
   ...
   public void onClick(View var1) {
      ...
      case 2131361874:
         ...
         return;
      case 2131361876:
         if(this.mUseClientCertificateView.isChecked()) {
            this.mUseClientCertificateView.setChecked((boolean)0);
            this.mCBAButton.setEnabled((boolean)0);
            return;
         }

         this.mUseClientCertificateView.setChecked((boolean)1);
         this.mCBAButton.setEnabled((boolean)1);
         return;
      case 2131361879:
         this.onCBA();
         return;
   ...
   public void onCreate(Bundle var1) {
      ...
      EmailTwSoftkeyItem var2 = (EmailTwSoftkeyItem)this.findViewById(2131361879);
      this.mCBAButton = var2;
      if(this.mCBAButton != null) {
         this.mCBAButton.setOnClickListener(this);
         this.mCBAButton.setEnabled((boolean)0);
      }

      EditText var3 = (EditText)this.findViewById(2131361870);
      this.mUsernameView = var3;
      EditText var4 = (EditText)this.findViewById(2131361849);
      this.mPasswordView = var4;
      EditText var5 = (EditText)this.findViewById(2131361871);
      this.mServerView = var5;
      CheckBox var6 = (CheckBox)this.findViewById(2131361873);
      ...
      CheckBox var7 = (CheckBox)this.findViewById(2131361875);
      this.mTrustCertificatesView = var7;
      this.mTrustCertificatesView.setOnClickListener(this);
      EmailTwSoftkeyItem var8 = (EmailTwSoftkeyItem)this.findViewById(2131361862);
      this.mNextTwSoftkeyItem = var8;
      this.mNextTwSoftkeyItem.setOnClickListener(this);
      LinearLayout var9 = (LinearLayout)this.findViewById(2131361872);
      this.mSslSecurityViewLayout = var9;
      this.mSslSecurityViewLayout.setOnClickListener(this);
      this.mSslSecurityViewLayout.setOnTouchListener(this);
      LinearLayout var10 = (LinearLayout)this.findViewById(2131361874);
      this.mTrustCertificatesViewLayout = var10;
      this.mTrustCertificatesViewLayout.setOnClickListener(this);
      this.mTrustCertificatesViewLayout.setOnTouchListener(this);
      CheckBox var11 = (CheckBox)this.findViewById(2131361877);
      this.mUseClientCertificateView = var11;
      this.mUseClientCertificateView.setOnCheckedChangeListener(this);
      this.mUseClientCertificateView.setOnClickListener(this);
      LinearLayout var12 = (LinearLayout)this.findViewById(2131361876);
      this.mUseClientCertificateViewLayout = var12;
      this.mUseClientCertificateViewLayout.setOnClickListener(this);
      this.mUseClientCertificateViewLayout.setOnTouchListener(this);
      AccountSetupExchange.1 var13 = new AccountSetupExchange.1();
      if(this.getIntent().getBooleanExtra("accountEdit", (boolean)0)) {
         this.mPasswordView.addTextChangedListener(var13);
         this.mServerView.addTextChangedListener(var13);
         this.mUsernameView.setEnabled((boolean)0);
         this.mUsernameView.setFocusable((boolean)0);
      } else {
         this.mUsernameView.addTextChangedListener(var13);
         this.mPasswordView.addTextChangedListener(var13);
         this.mServerView.addTextChangedListener(var13);
      }

      Intent var14 = this.getIntent();
      EmailContent.Account var15 = (EmailContent.Account)var14.getParcelableExtra("account");
      this.mAccount = var15;
      boolean var16 = var14.getBooleanExtra("makeDefault", (boolean)0);
      this.mMakeDefault = var16;
      boolean var17 = var14.getBooleanExtra("easFlow", (boolean)0);
      this.mEASFlowMode = var17;
      if(var1 != null && var1.containsKey("account")) {
         EmailContent.Account var18 = (EmailContent.Account)var1.getParcelable("account");
         this.mAccount = var18;
      }

      EmailContent.Account var19 = this.mAccount;
      this.loadFields(var19);
      boolean var20 = this.validateFields();
      this.performAutoDiscover(var14);
      SharedPreferences var21 = this.getSharedPreferences("AndroidMail.Main", 0);
      if(!var21.getBoolean("isSet", (boolean)0)) {
         Editor var22 = var21.edit();
         Editor var23 = var22.putBoolean("isSet", (boolean)1);
         Editor var24 = var22.putBoolean("isCheckIMEI", (boolean)1);
   ...
   public Dialog onCreateDialog(int var1) {
      ...
      switch(var1) {
      case 1:
         Builder var3 = (new Builder(this)).setIcon(17301543).setTitle(2131167106);
         ...
         var2 = var7.setPositiveButton(2131166262, var8).create();
         break;
      case 2:
         View var9 = LayoutInflater.from(this).inflate(2130903085, (ViewGroup)null);
         CheckBox var10 = (CheckBox)var9.findViewById(2131362061);
         ...
         Builder var14 = var12.setPositiveButton(2131166262, var13);
         AccountSetupExchange.4 var15 = new AccountSetupExchange.4();
         Builder var16 = var14.setNegativeButton(2131166263, var15);
   ...
   public boolean onTouch(View var1, MotionEvent var2) {
      ...
      case 2131361872:
         ...
         case 0:
            this.mSslSecurityView.setPressed((boolean)1);
            var3 = true;
            return var3;
         case 1:
            this.mSslSecurityView.setPressed((boolean)0);
            if(this.mSslSecurityView.isChecked()) {
               this.mSslSecurityView.setChecked((boolean)0);
            } else {
               this.mSslSecurityView.setChecked((boolean)1);
      ...
      case 2131361874:
         switch(var2.getAction()) {
         case 0:
            this.mTrustCertificatesView.setPressed((boolean)1);
            var3 = true;
            return var3;
         case 1:
            this.mTrustCertificatesView.setPressed((boolean)0);
            if(this.mTrustCertificatesView.isChecked()) {
               this.mTrustCertificatesView.setChecked((boolean)0);
            } else {
               this.mTrustCertificatesView.setChecked((boolean)1);
      ...
      case 2131361876:
         switch(var2.getAction()) {
         case 0:
            this.mUseClientCertificateView.setPressed((boolean)1);
            var3 = true;
            return var3;
         case 1:
            this.mUseClientCertificateView.setPressed((boolean)0);
            if(this.mUseClientCertificateView.isChecked()) {
               this.mUseClientCertificateView.setChecked((boolean)0);
            } else {
               this.mUseClientCertificateView.setChecked((boolean)1);
