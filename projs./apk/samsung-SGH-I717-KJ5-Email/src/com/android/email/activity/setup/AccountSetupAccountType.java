...
public class AccountSetupAccountType extends Activity implements OnClickListener {
   ...
   private void onExchange(boolean var1) {
      ...
      String var12 = SystemProperties.get("ro.csc.sales_code");
      SyncScheduleData var13;
      if(!"H3G".equals(var12) && !"3IE".equals(var12)) {
         if("NZC".equals(var12)) {
            var13 = new SyncScheduleData(480, 1020, 62, -1, -1, 1);
         } else {
            var13 = new SyncScheduleData(480, 1020, 62, -1, -1, 0);
         }
      } else {
         var13 = new SyncScheduleData(480, 1020, 62, 15, 15, 0);
      }

      this.mAccount.setSyncScheduleData(var13);
      boolean var14 = this.mAccount.setCalendarSyncLookback(4);
      EmailContent.Account var15 = this.mAccount;
      boolean var16 = this.mMakeDefault;
      boolean var17 = this.mAllowAutoDiscover;
      AccountSetupExchange.actionIncomingSettings(this, var15, var16, var1, var17);
      this.finish();
   }
      ...
      if(var5) {
         ...
         if(this.isExchangeAvailable()) {
            ...
            if(VendorPolicyLoader.getInstance(this).useAlternateExchangeStrings()) {
               ((Button)this.findViewById(2131361831)).setText(2131167066);
               ((Button)this.findViewById(2131361827)).setText(2131167066);
            }
         }
