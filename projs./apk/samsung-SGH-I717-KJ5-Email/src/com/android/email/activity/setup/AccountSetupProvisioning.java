...
public class AccountSetupProvisioning extends Z7AppBaseActivity implements OnItemClickListener {
   ...
   private List<IntArrayMap> getBasicConnectorList() {
      ...
      String var3 = this.getString(2131166957);
      var2.put(11, var3);
      ...
      String var18 = this.getString(2131166950);
      var17.put(11, var18);
   ...
   protected void onCreate(Bundle var1) {
      ...
      ListView var4 = (ListView)this.findViewById(2131361953);
      ...
      View var6 = this.usePremiumButtonView.findViewById(2131361978);
   ...
   private class ProvisionAdapter extends BaseAdapter {
      ...
      public View getView(int var1, View var2, ViewGroup var3) {
         ...
         if(var2 == null) {
            ...
            TextView var5 = (TextView)var2.findViewById(2131361955);
            var4.text = var5;
            ImageView var6 = (ImageView)var2.findViewById(2131361954);
            var4.icon = var6;
            var2.setTag(var4);
         } else {
   ...
   private class MyListener extends Email.Z7ConnectionListener {
      ...
      private List<IntArrayMap> addActiveSyncToList(List<IntArrayMap> var1) {
         ...
         String var12 = AccountSetupProvisioning.this.getString(2131166957);
         var11.put(11, var12);
      ...
      private boolean isNoGoogleSalesCode() {
         boolean var1 = false;
         String[] var2 = AccountSetupProvisioning.this.getResources().getStringArray(2131296305);
                     ...
                     if(var16 == var17) {
                        ...
                        if(var6.equals(var21)) {
                           ...
                           if(var1.hasErrorText()) {
                              ...
                              var31 = ANSharedCommon.fetchString(2131166963);
                           }
