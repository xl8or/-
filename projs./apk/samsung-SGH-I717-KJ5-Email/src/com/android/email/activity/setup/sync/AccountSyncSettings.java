...
public class AccountSyncSettings extends PreferenceActivity implements PreferenceConstants.EmailAccountPreferences, PreferenceConstants.GeneralPreferences {
   ...
   private void saveSettings() {
      if(this.mAccount != null) {
         ...
         Toast.makeText(this, 2131167001, 0).show();
      }
   }
   ...
   public void onCreate(Bundle var1) {
      ...
      if(this.mAccountId == 65535L) {
         ...
         if(this.mAccount == null) {
            ...
            this.mPeakStartTime.setTitle(2131166970);
            ...
            this.mPeakEndTime.setTitle(2131166971);
            ...
            this.mPeakDays.setTitle(2131166969);
            this.mPeakDays.setEntries(2131296299);
            this.mPeakDays.setEntryValues(2131296300);
            this.mPeakDays.setDialogTitle(2131166969);
            ListPreference var22 = this.mPeakDays;
            var8.addPreference(var22);
            String[] var24 = new String[7];
            String var25 = this.getString(2131166979);
            var24[0] = var25;
            String var26 = this.getString(2131166980);
            var24[1] = var26;
            String var27 = this.getString(2131166981);
            var24[2] = var27;
            String var28 = this.getString(2131166982);
            var24[3] = var28;
            String var29 = this.getString(2131166983);
            var24[4] = var29;
            String var30 = this.getString(2131166984);
            var24[5] = var30;
            String var31 = this.getString(2131166985);
            var24[6] = var31;
