...
public class OoOSetMessage extends Activity {
   ...
   protected void onCreate(Bundle var1) {
      ...
      Button var2 = (Button)this.findViewById(2131362215);
      this.mSetButton = var2;
      Button var3 = (Button)this.findViewById(2131362216);
      this.mCancelButton = var3;
      RadioButton var4 = (RadioButton)this.findViewById(2131362212);
      OoOSetMessage.1 var5 = new OoOSetMessage.1();
      var4.setOnClickListener(var5);
      RadioButton var6 = (RadioButton)this.findViewById(2131362213);
      ...
      if(this.mMsqReqType == 1) {
         ...
         if(var13 != null) {
            EditText var14 = (EditText)this.findViewById(2131362214);
            var14.setText(var13);
            int var15 = var13.length();
            var14.setSelection(var15);
         }
      } else {
         this.setTitle(2131166719);
         var13 = this.getIntent().getStringExtra("oooMsgReqDataExternalKnown");
         if(var13 != null) {
            EditText var16 = (EditText)this.findViewById(2131362214);
            var16.setText(var13);
            int var17 = var13.length();
            var16.setSelection(var17);
            if(var4 != null) {
            ...
            if(var13 != null) {
               EditText var18 = (EditText)this.findViewById(2131362214);
               var18.setText(var13);
               int var19 = var13.length();
               var18.setSelection(var19);
               if(var6 != null) {
   ...
   class 3 implements OnClickListener {
      ...
      public void onClick(View var1) {
         String var2 = ((EditText)OoOSetMessage.this.findViewById(2131362214)).getText().toString();
         if(var2.length() > 0) {
