...
public class ContactPreviewPopup extends Activity implements OnClickListener {
   ...
   public void UpdateContactInfo(Address var1) {
      ...
      if(this.lookupUri == null) {
         this.btnContact.setText(2131166552);
      } else {
         this.btnContact.setText(2131166553);
      }
   ...
   public void onClick(View var1) {
      ...
      case 2131362478:
         ...
         String var33 = this.context.getResources().getString(2131166553);
   ...
   public void onCreate(Bundle var1) {
      ...
      ImageView var14 = (ImageView)this.findViewById(2131362471);
      this.leftSpinImg = var14;
      ImageView var15 = (ImageView)this.findViewById(2131362473);
      ...
      if(this.personEmail != null) {
         ...
         TextView var38 = (TextView)this.findViewById(2131362472);
         TextView var39 = (TextView)this.findViewById(2131362475);
         this.nametext = var39;
         TextView var40 = (TextView)this.findViewById(2131362476);
         this.text2 = var40;
         TextView var41 = (TextView)this.findViewById(2131362477);
         this.text3 = var41;
         if(this.mType == 1) {
            var38.setText(2131166468);
         } else {
            var38.setText(2131166551);
         }
         ...
         ImageView var57 = (ImageView)this.findViewById(2131362474);
         this.image = var57;
         ...
         Button var60 = (Button)this.findViewById(2131362478);
         this.btnContact = var60;
         Button var61 = (Button)this.findViewById(2131362479);
         ...
         this.btnCompose.setText(2131166339);
