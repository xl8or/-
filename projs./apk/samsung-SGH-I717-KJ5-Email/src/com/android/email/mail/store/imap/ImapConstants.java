...
public final class ImapConstants {
   ...
   public static final String FETCH_FIELD_BODY_PEEK = "BODY.PEEK[]";
   public static final String FETCH_FIELD_BODY_PEEK_BARE = "BODY.PEEK";
   public static final String FETCH_FIELD_BODY_PEEK_SANE;
   public static final String FETCH_FIELD_HEADERS = "BODY.PEEK[HEADER.FIELDS (date subject from content-type to cc message-id disposition-notification-to)]";
   ...
   public static final String HASNOCHILDREN = "\\HASNOCHILDREN";
   ...
   public static final String NOINFERIORS = "\\NOINFERIORS";
   ...
   static {
      Object[] var0 = new Object[1];
      Integer var1 = Integer.valueOf('\uc800');
      var0[0] = var1;
      FETCH_FIELD_BODY_PEEK_SANE = String.format("BODY.PEEK[]<0.%d>", var0);
   }
