...
public abstract class Folder {
   ...
   public abstract Message[] getMessages(int var1, String var2, Folder.MessageRetrievalListener var3) throws MessagingException;
   ...
   public abstract String getParentFolderName();
   ...
   public abstract void reConnect(boolean var1);

   public abstract boolean rename(String var1) throws MessagingException;

   public abstract void setDelimiter(int var1);

   public abstract void setFlags(Message[] var1, Flag[] var2, boolean var3) throws MessagingException;

   public abstract void setFolderPath(String var1);

   public abstract void setParentFolderName(String var1);
   ...
   public interface MessageRetrievalListener {
      ...
      void messageFinished(Message var1, int var2, int var3);

      void messageStarted(String var1, int var2, int var3);
   }
