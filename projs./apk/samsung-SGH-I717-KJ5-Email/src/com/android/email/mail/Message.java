...
public abstract class Message implements Part, Body {
   ...
   protected boolean mAbnormalMessage = 0;
   ...
   public long getMessageId_original() {
      return this.mMessageId_original;
   }
   ...
   public void setMessageId_original(long var1) {
      this.mMessageId_original = var1;
   }
   ...
   public abstract void writeTo(Context var1, long var2, OutputStream var4) throws IOException, MessagingException;
