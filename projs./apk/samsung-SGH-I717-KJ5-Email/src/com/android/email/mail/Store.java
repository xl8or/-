...
public abstract class Store {
   ...
   public static void removeInstance(String var0) {
      ...
      try {
         Object var1 = mStores.remove(var0);
      } finally {
         ;
      }
   ...
   public abstract void removeFolder(String var1);

   public abstract void renameFolder(String var1, String var2);
   ...
   public static class StoreInfo {
      ...
      public static Store.StoreInfo getStoreInfo(String var0, Context var1) {
         Store.StoreInfo var2 = getStoreInfo(2131034138, var0, var1);
         if(var2 == null) {
            var2 = getStoreInfo(2131034137, var0, var1);
         }
