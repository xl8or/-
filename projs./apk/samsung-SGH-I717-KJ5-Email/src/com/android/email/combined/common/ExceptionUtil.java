...
public class ExceptionUtil {
   ...
   public static void exception(Activity var0) {
      Builder var1 = (new Builder(var0)).setMessage(2131166948);
      ExceptionUtil.2 var2 = new ExceptionUtil.2();
      var1.setPositiveButton(2131166262, var2).create().show();
   }
   ...
   public static void exception(Activity var0, int var1) {
      ...
      var2.setPositiveButton(2131166262, var3).create().show();
   }

   public static void exception(Context var0) {
      showToast(var0, 2131166948, 1);
   }
      ...
      if(var0 != null) {
         if(var1 != null) {
            ...
            if(var1 instanceof RemoteException) {
               var4 = var0.getString(2131166960);
            } else {
               var4 = var0.getString(2131166960);
            }

            try {
               (new Builder(var0)).setTitle(2131166959).setMessage(var4).setOnKeyListener(var3).setPositiveButton(2131166262, var2).create().show();
   ...
   public static void showDialogPremiumExpired(Activity var0) {
      Builder var1 = (new Builder(var0)).setMessage(2131166961);
      ExceptionUtil.4 var2 = new ExceptionUtil.4(var0);
      Builder var3 = var1.setPositiveButton(2131166466, var2);
      ExceptionUtil.3 var4 = new ExceptionUtil.3();
      var3.setNegativeButton(2131166998, var4).create().show();
   }
