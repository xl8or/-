               ...
               if(var4 != -1) {
                  ...
                  if(var8 > var9) {
                     ...
                     if(this.mParent != null) {
                        this.mParent.requestDisallowInterceptTouchEvent((boolean)1);
                     }
                  }
               }
            }
   ...
   public boolean onTouchEvent(MotionEvent var1) {
      ...
      if(var1.getAction() == 0 && var1.getEdgeFlags() != 0) {
         ...
         case 0:
            ...
            this.mIsBeingDragged = (boolean)var4;
            ...
            int var6 = var1.getPointerId(0);
            this.mActivePointerId = var6;
            break;
         case 1:
            if(this.bScrollBottom != 1 && this.mIsBeingDragged) {
               VelocityTracker var11 = this.mVelocityTracker;
               if(var11 != null) {
                  float var12 = (float)this.mMaximumVelocity;
                  var11.computeCurrentVelocity(1000, var12);
                  int var13 = this.mActivePointerId;
                  int var14 = (int)var11.getYVelocity(var13);
                  if(this.getChildCount() > 0) {
                     int var15 = Math.abs(var14);
                     int var16 = this.mMinimumVelocity;
                     if(var15 > var16) {
                        int var17 = -var14;
                        this.fling(var17);
                     }
         ...
         case 2:
            if(this.bScrollBottom != 1 && this.mIsBeingDragged) {
               ...
               int var8 = var1.findPointerIndex(var7);
               float var9 = var1.getY(var8);
               int var10 = (int)(this.mLastMotionY - var9);
               this.mLastMotionY = var9;
               this.scrollBy(0, var10);
            }
            break;
         case 3:
