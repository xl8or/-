...
public class MessagingController implements Runnable {
   ...
   // $FF: synthetic method
   static boolean access$1100(MessagingController var0, EmailContent.Account var1, ContentResolver var2, HashMap var3, long var4, long var6) throws MessagingException {
      return var0.processPendingMultiMoveSynchronous(var1, var2, var3, var4, var6);
   }
   ...
   private void copyOneMessageToProvider(Message param1, EmailContent.Account param2, EmailContent.Mailbox param3, int param4, boolean param5, ArrayList<Part> param6) {
      // $FF: Couldn't be decompiled
   }
   ...
   private void processPendingActionsSynchronous(EmailContent.Account var1, boolean var2, boolean var3) throws MessagingException {
      if(var1 != null) {
         ...
         int var14 = Log.d("Email", "PERFORMANCE DELETE START");
         this.processPendingMultiDeletesSynchronous(var1, var4, var5);
         int var15 = Log.d("Email", "PERFORMANCE DELETE END");
         if(var7 == 0 && !var2 && var3) {
            this.processPendingUploadsSynchronous(var1, var4, var5);
         }
               ...
               if(var16 == null) {
                  ...
                  if(var18.exists()) {
                     ...
                     if(var26 != var27) {
                        ...
                        MessagingController.15 var29 = new MessagingController.15();
                        var10.copyMessages(var28, var18, var29);
                        var18.close((boolean)0);
                        Flag var30 = Flag.DELETED;
                        var16.setFlag(var30, (boolean)1);
                        Message[] var31 = var10.expunge();
                        var10.close((boolean)0);
                        var8 = true;
                     }
                  } else {
                                 ...
                                 if(var17 == null) {
                                    ...
                                    if(var19.exists()) {
                                       ...
                                       try {
                                          ...
                                          var26[0] = var17;
                                          MessagingController.16 var27 = new MessagingController.16(var5);
   ...
   private void processPendingMultiDeleteFromTrash(Store var1, EmailContent.Account var2, EmailContent.Mailbox var3, HashSet<String> var4) throws MessagingException {
      if(var3 != null) {
         if(var3.mType == 6) {
            String var5 = var3.mDisplayName;
            Folder var6 = var1.getFolder(var5);
            if(var6.exists()) {
               ...
               if(var8 != var9) {
                  ...
                  Message[] var10 = null;
                  if(var4.toArray().length > 0) {
                     String[] var11 = new String[var4.toArray().length];
                     String[] var12 = (String[])((String[])var4.toArray(var11));
                     var10 = var6.getMessages(var12, (Folder.MessageRetrievalListener)null);
                  }
                  ...
                  if(var10 != null) {
                     ...
                     for(int var15 = 0; var15 < var14; ++var15) {
                        Message var16 = var13[var15];
                        if(var16 != null) {
                           Flag var17 = Flag.DELETED;
                           var16.setFlag(var17, (boolean)1);
                        }
                     }
                  }

                  Message[] var18 = var6.expunge();
                  var6.close((boolean)0);
               }
            }
         }
   ...
   private void processPendingMultiDeletesSynchronous(EmailContent.Account var1, ContentResolver var2, String[] var3) throws MessagingException {
      Uri var4 = EmailContent.Message.DELETED_CONTENT_URI;
      String[] var5 = EmailContent.Message.CONTENT_PROJECTION_UP_DEL;
      Cursor var8 = var2.query(var4, var5, "accountKey=?", var3, "mailboxKey");
      long var9 = 65535L;
      Store var11 = null;
      EmailContent.Mailbox var12 = null;
      ...
      try {
         ...
         if(true) {
            ...
            String var18 = var1.getStoreUri(var15);
            Context var19 = this.mContext;
            var11 = Store.getInstance(var18, var19, (Store.PersistentDataCallbacks)null);
         }

         while(var8.moveToNext()) {
            EmailContent.Message var20 = (EmailContent.Message)EmailContent.getContent(var8, EmailContent.Message.class);
            if(var20 != null) {
               label107: {
                  var9 = var20.mId;
                  if(var12 != null) {
                     long var21 = var12.mId;
                     long var23 = var20.mMailboxKey;
                     if(var21 == var23) {
                        break label107;
                     }
                  }
                  ...
                  long var26 = var20.mMailboxKey;
                  var12 = EmailContent.Mailbox.restoreMailboxWithId(var25, var26);
               }

               if(var12.mType == 6) {
                  String var28 = var20.mServerId;
                  var13.add(var28);
                  Long var30 = Long.valueOf(var20.mId);
                  var14.add(var30);
               }
            }
         }
         ...
         if(var13.size() > 0) {
            this.processPendingMultiDeleteFromTrash(var11, var1, var12, var13);
         }

         Iterator var47 = var14.iterator();

         while(var47.hasNext()) {
            long var48 = ((Long)var47.next()).longValue();
            Uri var50 = EmailContent.Message.DELETED_CONTENT_URI;
            Uri var53 = ContentUris.withAppendedId(var50, var48);
            Object var56 = null;
            Object var57 = null;
            var2.delete(var53, (String)var56, (String[])var57);
         }
      } catch (Exception var61) {
         if(Email.DEBUG) {
            StringBuilder var33 = (new StringBuilder()).append("Unable to process pending delete for id=");
            StringBuilder var36 = var33.append(var9).append(": ");
            String var38 = var36.append(var61).toString();
            int var39 = Log.d("Email", var38);
         }

         String var40 = var61.getMessage();
         throw new MessagingException(var40);
      } finally {
         var8.close();
      }
   ...
   private boolean processPendingMultiMoveSynchronous(EmailContent.Account param1, ContentResolver param2, HashMap<String, Long> param3, long param4, long param6) throws MessagingException {
      // $FF: Couldn't be decompiled
   }
   ...
   public void checkMail(long var1, long var3, MessagingListener var5) {
      ...
      MessagingController.20 var17 = new MessagingController.20(var1, var3);
   ...
   public void loadMessageForView(long var1, MessagingListener var3) {
      ...
      MessagingController.17 var4 = new MessagingController.17(var1);
   ...
   public void processPendingMoveActions(HashMap<String, Long> var1, long var2, long var4, long var6) {
   ...
   public void sendPendingMessages(EmailContent.Account var1, long var2, MessagingListener var4) {
      MessagingController.19 var5 = new MessagingController.19(var1, var2);
   ...
   class 8 implements Folder.MessageRetrievalListener {
      ...
      public void messageFinished(Message var1, int var2, int var3) {
         ...
         byte var8 = 1;
         var4.copyOneMessageToProvider(var1, var5, var6, 1, (boolean)var8, (ArrayList)null);
      }
         ...
         if(var6 != null) {
            ...
            if(var1 != 65535L) {
               ...
               if(var15 != null) {
                  ...
                  long var17 = this.val$accountId;
                  DoExternalRequest.sendBroadcastSyncCompleted(var16, var17);
               }
            }
         }

         GroupMessagingListener var19 = MessagingController.this.mListeners;
         Context var20 = MessagingController.this.mContext;
         long var21 = this.val$accountId;
         long var23 = this.val$tag;
         var19.checkMailFinished(var20, var21, var1, var23);
      }
   }
   ...
   class 12 implements Runnable {
      ...
      final long val$accountId;
      // $FF: synthetic field
      final HashMap val$final_serverIds;
      // $FF: synthetic field
      final long val$orig_boxkey;
      // $FF: synthetic field
      final long val$target_boxkey;
      ...
      12(MessagingController param1, long param2, HashMap param4, long param5, long param7) {
         // $FF: Couldn't be decompiled
      }
      ...
      public void run() {
         ...
         try {
            ...
            int var6 = Log.d("Email", "PERFORMANCE MOVE START");
            MessagingController var7 = this.this$0;
            HashMap var8 = this.val$final_serverIds;
            long var9 = this.val$target_boxkey;
            long var11 = this.val$orig_boxkey;
            var13 = MessagingController.access$1100(var7, var4, var5, var8, var9, var11);
            int var14 = Log.d("Email", "PERFORMANCE MOVE END");
               ...
               if(var19 != null && var23 != null) {
                  if(!MessagingController.this.checkITPolicy_AllowPOPIMAP(var19)) {
                     ...
                     if(!MessagingController.this.checkITPolicy_AllowPOPIMAP(var19)) {
                        ...
                        if(var43 != null) {
                           MessagingController.this.copyOneMessageToProvider(var43, var19, var23, 1, (boolean)0, (ArrayList)null);
                        }
   ...
   class 16 implements Folder.MessageUpdateCallbacks {

      // $FF: synthetic field
      final EmailContent.Message val$newMessage;


      16(EmailContent.Message var2) {
   ...
   class 19 implements Runnable {
      ...
      19(EmailContent.Account var2, long var3) {
         this.val$account = var2;
   ...
   class 18 implements Runnable {
      ...
      18(boolean var2, long var3, long var5, long var7, long var9, boolean var11) {
         this.val$prune = var2;
         this.val$accountId = var3;
