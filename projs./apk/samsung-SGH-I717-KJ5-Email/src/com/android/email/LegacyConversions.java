...
public class LegacyConversions {
   ...
   private static void addOneAttachment(Context var0, EmailContent.Message var1, Part var2, boolean var3, EmailContent.Account var4) throws MessagingException, IOException {
      ...
      label341: {
         ...
         if(var3) {
            ...
            String var54 = var2.getDisposition();
            if(var54 != null) {
               var54 = MimeUtility.getHeaderParameter(var54, "size");
               if(var54 != null) {
                  var18 = Long.parseLong(var54);
                  break label341;
               }
            }
         }
      ...
      String[] var25 = var2.getHeader("Content-Transfer-Encoding");
      String var26;
      if(var25 != null) {
         var26 = var25[0];
      } else {
      ...
      byte var29;
      label320: {
         var5.mEncoding = var26;
         byte var27 = 0;
         if(var4 != null) {
            Store.StoreInfo var66 = Store.StoreInfo.getStoreInfo(var4.getStoreUri(var0), var0);
            if(var66 != null) {
               String var28 = var66.mScheme;
               var29 = "pop3".equalsIgnoreCase(var28);
               break label320;
            }
         }
      ...
      if(var29 == 1) {
         Uri var30 = EmailContent.Attachment.MESSAGE_ID_URI;
         long var31 = var1.mId;
         Uri var33 = ContentUris.withAppendedId(var30, var31);
         ContentResolver var34 = var0.getContentResolver();
         String[] var35 = EmailContent.Attachment.CONTENT_PROJECTION;
         Cursor var36 = var34.query(var33, var35, (String)null, (String[])null, (String)null);
         boolean var69 = false;
         ...
         while(true) {
            ...
            try {
               var60 = true;
               if(var36.moveToNext()) {
                  EmailContent.Attachment var37 = (new EmailContent.Attachment()).restore(var36);
                  String var38 = var37.mFileName;
                  String var39 = var5.mFileName;
                  if(stringNotEqual(var38, var39)) {
                     continue;
                  }

                  String var40 = var37.mMimeType;
                  String var41 = var5.mMimeType;
                  if(stringNotEqual(var40, var41)) {
                     continue;
                  }

                  String var42 = var37.mContentId;
                  String var43 = var5.mContentId;
                  if(stringNotEqual(var42, var43)) {
                     continue;
                  }

                  String var44 = var37.mLocation;
                  String var45 = var5.mLocation;
                  if(stringNotEqual(var44, var45)) {
                     continue;
                  }

                  var69 = true;
                  long var46 = var37.mId;
                  var5.mId = var46;
                  var60 = false;
                  break;
               }
      ...
      if(!var3) {
         long var49 = var1.mAccountKey;
         saveAttachmentBody(var0, var2, var5, var49);
      }

      if(var1.mAttachments == null) {
         ArrayList var51 = new ArrayList();
         var1.mAttachments = var51;
      }
   ...
   private static String makeDisplayName(Context var0, String var1, String var2, String var3) {
      ...
      if(var5 == 0) {
         ...
         if(var5 == 1) {
            ...
            var13[1] = var14;
            var11 = var0.getString(2131167160, var13);
         }
      }
   ...
   public static boolean updateBodyFields(Context var0, EmailContent.Body var1, EmailContent.Message var2, ArrayList<Part> var3) throws MessagingException {
                  ...
                  label104: {
                     try {
                        ...
                        if(!var18) {
                           ...
                           String var35 = var0.getString(2131167138);
                        ...
                        String var24 = var0.getString(2131167138);
      ...
      if(var11 != null && var11.length() != 0) {
         String var37 = var11.toString();
         var1.mHtmlContent = var37;
         String var38 = Snippet.fromHtmlText(var1.mHtmlContent);
         var2.mSnippet = var38;
      }

      if(var10 != null && var10.length() != 0) {
         String var39 = var10.toString();
         var1.mTextContent = var39;
         if(var2.mSnippet == null) {
            String var40 = Snippet.fromPlainText(var1.mTextContent);
            var2.mSnippet = var40;
         }
      }
   ...
   public static boolean updateMessageFields(Context var0, EmailContent.Message var1, Message var2, EmailContent.Account var3, long var4) throws MessagingException {
      Address[] var6 = var2.getFrom();
      Message.RecipientType var7 = Message.RecipientType.TO;
      Address[] var10 = var2.getRecipients(var7);
      Message.RecipientType var11 = Message.RecipientType.CC;
      Address[] var14 = var2.getRecipients(var11);
      Message.RecipientType var15 = Message.RecipientType.BCC;
      Address[] var18 = var2.getRecipients(var15);
      Address[] var19 = var2.getReplyTo();
      Address[] var20 = var2.getReadReceiptTo();
      ...
      if(var25 != null) {
         ...
         Date var87 = var2.getReceivedDate();
         if(var22 != null) {
            var23 = var22.getTime();
         } else if(var87 != null) {
            var23 = var87.getTime();
      ...
      if(var23 != 0L) {
         ...
         int var88 = Log.d("Email", "*****[toma_naver] localMessage.mTimeStamp = null ");
      }

      if(var6 != null && var6.length > 0) {
         String var28 = var6[0].toFriendly();
         var1.mDisplayName = var28;
      } else {
         int var89 = Log.d("Email", "*****[toma_naver] localMessage.mDisplayName null ");
      }

      if(var21 != null) {
         var1.mSubject = var21;
      } else {
         int var90 = Log.d("Email", "*****[toma_naver] localMessage.mSubject == null");
      }
      ...
      label79: {
         byte var41 = 0;
         if(var3 != null) {
            String var44 = var3.getStoreUri(var0);
            Store.StoreInfo var46 = Store.StoreInfo.getStoreInfo(var44, var0);
            if(var46 != null) {
               String var47 = var46.mScheme;
               var48 = "pop3".equalsIgnoreCase(var47);
               break label79;
            }
         }
      ...
      if(var48 == 0) {
         Flag var49 = Flag.FLAGGED;
         boolean var52 = var2.isSet(var49);
         var1.mFlagFavorite = var52;
      }

      String var53 = var2.getUid();
      var1.mServerId = var53;
      if(var22 != null) {
         long var54 = var22.getTime();
         var1.mServerTimeStamp = var54;
      }

      String var56 = ((MimeMessage)var2).getMessageId();
      if(var56 != null) {
         var1.mMessageId = var56;
      }

      var1.mMailboxKey = var4;
      long var60 = var3.mId;
      var1.mAccountKey = var60;
      if(var6 != null && var6.length > 0) {
         String var62 = Address.pack(var6);
         var1.mFrom = var62;
      }

      String var63 = Address.pack(var10);
      var1.mTo = var63;
      String var64 = Address.pack(var14);
      var1.mCc = var64;
      String var65 = Address.pack(var18);
      var1.mBcc = var65;
      String var66 = Address.pack(var19);
      var1.mReplyTo = var66;
      long var67 = var3.mId;
      byte var72 = 5;
      long var73 = EmailContent.Mailbox.findMailboxOfType(var0, var67, var72);
      if(var4 == var73) {
         String var75 = var1.mTo;
         Object var78 = null;
         Object var79 = null;
         String var80 = makeDisplayName(var0, var75, (String)var78, (String)var79);
         var1.mDisplayName = var80;
      } else if(var6 != null && var6.length > 0) {
         String var92 = var6[0].toFriendly();
         var1.mDisplayName = var92;
      } else {
         String var93 = "Email";
         String var94 = "***** localMessage.mDisplayName null ";
         Log.d(var93, var94);
      }

      String var81 = Address.pack(var20);
      if(var81 != null) {
         String var83 = "";
         if(!var81.equals(var83)) {
            int var84 = var1.mFlags | 1024;
            var1.mFlags = var84;
         }
      }

      long var85 = EmailContent.Message.getThreadIdFromSubject(var1.mSubject);
      var1.mThreadId = var85;
      return true;
   }
}
