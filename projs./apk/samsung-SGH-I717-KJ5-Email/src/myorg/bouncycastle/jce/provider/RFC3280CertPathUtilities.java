...
public class RFC3280CertPathUtilities {
   ...
   protected static Set processCRLF(X509CRL var0, Object var1, X509Certificate var2, PublicKey var3, ExtendedPKIXParameters var4, List var5) throws AnnotatedException {
      ...
      try {
         ...
         throw new AnnotatedException("Subject criteria for certificate selector to find issuer certificate for CRL could not be set.", var47);
      }
      ...
      } catch (AnnotatedException var54) {
         throw new AnnotatedException("Issuer certificate for CRL cannot be searched.", var54);
      }
      ...
      while(var16.hasNext()) {
         ...
         if(var19.equals(var2)) {
            ...
            label85: {
               ...
               } catch (CertPathBuilderException var51) {
                  var30 = var51;
                  throw new AnnotatedException("Internal error.", var30);
               } catch (CertPathValidatorException var52) {
                  var32 = var52;
               ...
               try {
                  ...
                  var18.add(var28);
                  continue;
               } catch (CertPathBuilderException var48) {
                  var30 = var48;
                  throw new AnnotatedException("Internal error.", var30);
               } catch (CertPathValidatorException var49) {
                  var32 = var49;
                  throw new AnnotatedException("Public key of issuer certificate of CRL could not be retrieved.", var32);
               } catch (Exception var50) {
                  var34 = var50;
