...
public class IOUtils {
   ...
   public static long copyLarge_status(InputStream var0, OutputStream var1, Folder.MessageRetrievalListener var2, int var3) throws IOException {
      byte[] var4 = new byte[4096];
      long var5 = 0L;
      int var7 = 0;

      while(true) {
         int var8 = var0.read(var4);
         if(-1 == var8) {
            if(var2 != null) {
               int var21 = getCopyCount((long)var3);
               var2.messageStarted((String)null, 200, var21);
            }

            return var5;
         }

         var1.write(var4, 0, var8);
         long var9 = (long)var8;
         var5 += var9;
         if(Controller.Attachdownstop) {
            int var11 = Log.v("IOUtils", "Attachmentdownload is cancelled in copyLarge_status");
         ...
         if(var3 != 0) {
            label32: {
               if(var7 % 5 != 0) {
                  long var12 = 100L * var5;
                  long var14 = (long)var3;
                  if(var12 / var14 <= 90L || var7 % 2 != 0) {
               ...
               if(var2 != null) {
                  String var18 = "count = " + var5 + "total = " + var3;
                  int var19 = Log.v("IOUtils", var18);
                  int var20 = getCopyCount(var5);
                  var2.messageStarted((String)null, 200, var20);
               }
            }
         }
   ...
   public static int copy_status(InputStream var0, OutputStream var1, Folder.MessageRetrievalListener var2, int var3) throws IOException {
      long var4 = copyLarge_status(var0, var1, var2, var3);
      int var6;
      if(var4 > 2147483647L) {
         var6 = -1;
      } else {
   ...
   private static int getCopyCount(long var0) {
      return (int)var0;
   }
